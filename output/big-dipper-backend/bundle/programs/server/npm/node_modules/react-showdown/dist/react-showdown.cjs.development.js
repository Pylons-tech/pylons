...
function MarkdownView(props) {
  ...
  var mapElement = React.useMemo(function () {
    return function mapElement(node, index) {
      if (node.type === 'tag' && node instanceof domhandler.Element) {
        ...
        return React.createElement('style', _props2, _children);
      } else {
  ...
  return React.createElement('div', otherProps, root.map(mapElement));
...
function filterWhitespaceElements(node) {
  if (node.type === 'text' && node instanceof domhandler.DataNode) {
...
var setExtension = showdown.extension;
var getExtension = showdown.extension;
var GlobalConfiguration = {
  // Flavors,
  setFlavor: showdown.setFlavor,
  getFlavor: showdown.getFlavor,
  // Options
  setOption: showdown.setOption,
  getOption: showdown.getOption,
  getOptions: showdown.getOptions,
  resetOptions: showdown.resetOptions,
  // Extensions
  setExtension: setExtension,
  getExtension: getExtension,
  getAllExtensions: showdown.getAllExtensions,
  removeExtension: showdown.removeExtension,
  resetExtensions: showdown.resetExtensions
};

exports.GlobalConfiguration = GlobalConfiguration;
exports.Markdown = Markdown;
exports.default = MarkdownView;
//# sourceMappingURL=react-showdown.cjs.development.js.map
