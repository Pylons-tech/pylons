...
<head>
    <title>Code coverage report for easing/utils.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">easing</a> utils.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Easing, EasingModifier } from "./types"
&nbsp;
...
export const createAnticipate = (power: number): Easing =&gt; {
    ...
    return p =&gt;
        (p *= 2) &lt; 1
            ? 0.5 * backEasing(p)
            : <span class="branch-1 cbranch-no" title="branch not covered" >0.5 * (2 - Math.pow(2, -10 * (p - 1)))</span>
}
&nbsp;</pre></td></tr></table></pre>
