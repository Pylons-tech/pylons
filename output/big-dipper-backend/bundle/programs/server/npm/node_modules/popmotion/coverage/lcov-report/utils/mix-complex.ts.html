...
<head>
    <title>Code coverage report for utils/mix-complex.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">utils</a> mix-complex.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { color, complex, RGBA, HSLA } from 'style-value-types';
import { mix } from './mix';
...
&nbsp;
  for (const key in output) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (origin[key] !== undefined &amp;&amp; target[key] !== undefined) {
