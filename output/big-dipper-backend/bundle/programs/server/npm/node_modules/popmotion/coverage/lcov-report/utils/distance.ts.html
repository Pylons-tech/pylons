...
<head>
    <title>Code coverage report for utils/distance.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">utils</a> distance.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Point } from "../types"
...
export function distance&lt;P extends Point | number&gt;(a: P, b: P): number {
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (isPoint(a) &amp;&amp; isPoint(b)) {
        // Multi-dimensional
