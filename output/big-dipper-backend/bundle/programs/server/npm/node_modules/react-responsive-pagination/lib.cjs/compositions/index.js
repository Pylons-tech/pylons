...
function narrowToWideCompositions(current, total, narrowStrategies) {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (current === null)
                    return [2 /*return*/];
                compositions = narrowToWideCompositionsUnfiltered(current, total);
...
function narrowToWideCompositionsUnfiltered(current, total) {
