...
import { $controls, $promptElement, cameraOrbitIntrinsics, ControlsMixin, INTERACTION_PROMPT, OLD_DEFAULT_FOV_DEG } from '../../features/controls.js';
import ModelViewerElementBase, { $scene, $statusElement, $userInputElement } from '../../model-viewer-base.js';
import { StyleEvaluator } from '../../styles/evaluators.js';
import { ChangeSource, KeyCode } from '../../three-components/SmoothControls.js';
            ...
            suite('a11y', () => {
                ...
                suite('when configured for focus-based interaction prompting', () => {
                    ...
                    test.skip('prompts user to interact when focused', async () => {
                        ...
                        await until(() => {
                            var _a;
                            return !!((_a = input.getAttribute('aria-label')) === null || _a === void 0 ? void 0 : _a.includes(INTERACTION_PROMPT));
                        });
                        expect(promptElement.classList.contains('visible'))
                            .to.be.equal(true);
                    });
