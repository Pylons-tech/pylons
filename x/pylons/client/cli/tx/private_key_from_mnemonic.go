...
func ComputePrivateKey(codec *codec.Codec) *cobra.Command {
	cmd := &cobra.Command{
		...
		`,
		PreRun: preSignCmd,
		RunE:   makeComputePrivateKeyCmd(codec),
...
func makeComputePrivateKeyCmd(cdc *codec.Codec) func(cmd *cobra.Command, args []string) error {
