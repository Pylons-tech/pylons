...
func NewMsgCreateRecipe(recipeName, cookbookName, description string, inputs types.CoinInputList, outputs types.CoinOutputList, sender sdk.AccAddress) MsgCreateRecipe {
