...
func (querier *querierServer) GetActiveCookbook(ctx context.Context, req *types.GetCookbookRequest) (*types.GetCookbookResponse, error) {
	if req.CookbookID == "" {
...
func (querier *querierServer) ActiveListCookbook(ctx context.Context, req *types.ActiveListCookbookRequest) (*types.ActiveListCookbookResponse, error) {
	var err error
	...
	return &types.ActiveListCookbookResponse{Cookbooks: cookbooks}, nil
}
