...
func mockCookbook(tci TestCoinInput, sender sdk.AccAddress) handlers.CreateCBResponse {
	...
	cbResult := handlers.HandlerMsgCreateCookbook(tci.ctx, tci.plnK, msg)
	cbData := handlers.CreateCBResponse{}
