...
type Params struct {
	...
	TxSizeLimitBytes          uint64                                 `protobuf:"varint,11,opt,name=txSizeLimitBytes,proto3" json:"txSizeLimitBytes,omitempty" yaml:"tx_size_limit_byes"`
	TxSizeFeePerByte          types.Coin                             `protobuf:"bytes,12,opt,name=txSizeFeePerByte,proto3" json:"txSizeFeePerByte" yaml:"tx_size_fee_per_byte"`
}
...
func (m *Params) GetTxSizeLimitBytes() uint64 {
	if m != nil {
		return m.TxSizeLimitBytes
	}
	return 0
}

func (m *Params) GetTxSizeFeePerByte() types.Coin {
	if m != nil {
		return m.TxSizeFeePerByte
	}
	return types.Coin{}
}
...
var fileDescriptor_32b96d3026fd9730 = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if this.TxSizeLimitBytes != that1.TxSizeLimitBytes {
		return false
	}
	if !this.TxSizeFeePerByte.Equal(&that1.TxSizeFeePerByte) {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.TxSizeFeePerByte.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	i--
	dAtA[i] = 0x62
	if m.TxSizeLimitBytes != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.TxSizeLimitBytes))
		i--
		dAtA[i] = 0x58
	}
...
func (m *Params) Size() (n int) {
	...
	if m.TxSizeLimitBytes != 0 {
		n += 1 + sovParams(uint64(m.TxSizeLimitBytes))
	}
	l = m.TxSizeFeePerByte.Size()
	n += 1 + l + sovParams(uint64(l))
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxSizeLimitBytes", wireType)
			}
			m.TxSizeLimitBytes = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowParams
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TxSizeLimitBytes |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxSizeFeePerByte", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.TxSizeFeePerByte.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
