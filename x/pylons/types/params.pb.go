...
type PaymentProcessor struct {
	...
	ProcessingCut github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=processingCut,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"processingCut" yaml:"processing_cut"`
	// Represents the percentage distributed to stakers. In the range [0, 1). The sum with processingCut cannot exceed 1.
	ConsensusCut github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,4,opt,name=consensusCut,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"consensusCut" yaml:"consensus_cut"`
...
var fileDescriptor_32b96d3026fd9730 = []byte{
	...
	,
}
...
func (this *PaymentProcessor) Equal(that interface{}) bool {
	...
	if !this.ProcessingCut.Equal(that1.ProcessingCut) {
		return false
	}
	if !this.ConsensusCut.Equal(that1.ConsensusCut) {
		return false
	}
...
func (m *PaymentProcessor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	{
		size := m.ConsensusCut.Size()
		i -= size
		if _, err := m.ConsensusCut.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintParams(dAtA, i, uint64(size))
	}
	...
	dAtA[i] = 0x22
	{
		size := m.ProcessingCut.Size()
		i -= size
		if _, err := m.ProcessingCut.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintParams(dAtA, i, uint64(size))
	}
...
func (m *PaymentProcessor) Size() (n int) {
	...
	l = m.ProcessingCut.Size()
	n += 1 + l + sovParams(uint64(l))
	l = m.ConsensusCut.Size()
	n += 1 + l + sovParams(uint64(l))
	l = len(m.Name)
	if l > 0 {
		n += 1 + l + sovParams(uint64(l))
...
func (m *PaymentProcessor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProcessingCut", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ProcessingCut.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConsensusCut", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ConsensusCut.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
