...
type EventFulfillTrade struct {
	...
	CoinInput   types.Coin `protobuf:"bytes,5,opt,name=coinInput,proto3" json:"coinInput"`
	ItemOutputs []ItemRef  `protobuf:"bytes,6,rep,name=itemOutputs,proto3" json:"itemOutputs"`
	CoinOutput  types.Coin `protobuf:"bytes,7,opt,name=coinOutput,proto3" json:"coinOutput"`
}
...
func (m *EventFulfillTrade) GetCoinInput() types.Coin {
	if m != nil {
		return m.CoinInput
	}
	return types.Coin{}
...
func (m *EventFulfillTrade) GetCoinOutput() types.Coin {
	if m != nil {
		return m.CoinOutput
	}
	return types.Coin{}
...
var fileDescriptor_3d5fff376ba53ecd = []byte{
	...
	,
}
