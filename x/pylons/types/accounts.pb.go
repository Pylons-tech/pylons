...
type KYCUsername struct {
	Value string `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty"`
}

func (m *KYCUsername) Reset()         { *m = KYCUsername{} }
func (m *KYCUsername) String() string { return proto.CompactTextString(m) }
func (*KYCUsername) ProtoMessage()    {}
func (*KYCUsername) Descriptor() ([]byte, []int) {
	return fileDescriptor_d25da355fd1de5b5, []int{6}
}
func (m *KYCUsername) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *KYCUsername) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_KYCUsername.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *KYCUsername) XXX_Merge(src proto.Message) {
	xxx_messageInfo_KYCUsername.Merge(m, src)
}
func (m *KYCUsername) XXX_Size() int {
	return m.Size()
}
func (m *KYCUsername) XXX_DiscardUnknown() {
	xxx_messageInfo_KYCUsername.DiscardUnknown(m)
}

var xxx_messageInfo_KYCUsername proto.InternalMessageInfo

func (m *KYCUsername) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*KYCUsername)(nil), "pylons.pylons.KYCUsername")
}
...
var fileDescriptor_d25da355fd1de5b5 = []byte{
	...
	0x54, 0xff, 0x20, 0x5b, 0xcd, 0x84, 0x62, 0xb5, 0x92, 0x12, 0x17, 0x97, 0x77, 0xa4, 0xb3, 0x23,
	0xd4, 0x21, 0x38, 0xfd, 0xea, 0x1d, 0xe9, 0x8c, 0x3f, 0x40, 0x9c, 0xdc, 0x4e, 0x3c, 0x92, 0x63,
	...
	0x3f, 0x57, 0x3f, 0x00, 0xec, 0x23, 0xdd, 0x92, 0xd4, 0xe4, 0x0c, 0x58, 0x4c, 0x57, 0xc0, 0x18,
	0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0xe0, 0xb8, 0x34, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff,
	0xaa, 0x45, 0xc5, 0x76, 0x10, 0x02, 0x00, 0x00,
}
...
func (m *KYCUsername) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *KYCUsername) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *KYCUsername) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *KYCUsername) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KYCUsername: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KYCUsername: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
