...
var (
	DefaultCoinIssuers = []CoinIssuer{
		{
			...
			Packages: []GoogleInAppPurchasePackage{
				...
				{PackageName: "tech.pylons.wallet", ProductId: "pylons_30", Amount: sdk.NewInt(30000000)},
				{PackageName: "tech.pylons.wallet", ProductId: "pylons_35", Amount: sdk.NewInt(35000000)},
				{PackageName: "tech.pylons.wallet", ProductId: "pylons_50", Amount: sdk.NewInt(50000000)},
				{PackageName: "tech.pylons.wallet", ProductId: "pylons_60", Amount: sdk.NewInt(60000000)},
				{PackageName: "tech.pylons.wallet", ProductId: "pylons_100", Amount: sdk.NewInt(100000000)},
				{PackageName: "tech.pylons.wallet", ProductId: "pylons_500", Amount: sdk.NewInt(500000000)},
				{PackageName: "tech.pylons.wallet", ProductId: "pylons_1000", Amount: sdk.NewInt(1000000000)},
				{PackageName: "tech.pylons.wallet", ProductId: "pylons_10000", Amount: sdk.NewInt(10000000000)},
				{PackageName: "tech.pylons.wallet", ProductId: "pylons_30000", Amount: sdk.NewInt(30000000000)},
				{PackageName: "tech.pylons.wallet", ProductId: "pylons_100000", Amount: sdk.NewInt(100000000000)},
			},
	...
	DefaultPylonsIncPubKey         = "JgxPJ/hZe0nZ019iSmL+gIPM/pO8i3s8AsikLjoJAJs="                            // this is a production public key for stripe
