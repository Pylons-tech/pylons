	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			args: args{
				...
				toPay: sdk.NewCoins(sdk.NewCoin(types.StripeCoinDenom, sdk.NewInt(997_000_000))),
			},
			wantErr: false,
		},
		{
		...
		},
		{
			...
			args: args{
				...
				toPay: sdk.NewCoins(sdk.NewCoin(types.StripeCoinDenom, sdk.NewInt(1_000_000_000))),
			},
			wantErr: true,
		},
	} {
