...
func (suite *IntegrationTestSuite) TestMsgServerGoogleInAppPurchaseGetCoins() {
	...
	for _, tc := range []struct {
		desc    string
		request *v1beta1.MsgGoogleInAppPurchaseGetCoins
		balance sdk.Coins
		err     error
	}{
		{
			...
			desc: "WrongEncoding",
			request: &v1beta1.MsgGoogleInAppPurchaseGetCoins{
				Creator:           v1beta1.GenTestBech32FromString("sender"),
				ProductId:         "pylons_10",
		...
		},
		{
			desc: "Valid1",
			request: &v1beta1.MsgGoogleInAppPurchaseGetCoins{
				Creator:           v1beta1.GenTestBech32FromString("sender2"),
				ProductId:         "pylons_10",
			...
			balance: sdk.NewCoins(sdk.NewCoin(v1beta1.PylonsCoinDenom, sdk.NewInt(10000000))),
		},
		{
			desc: "Valid2",
			request: &v1beta1.MsgGoogleInAppPurchaseGetCoins{
			...
			balance: sdk.NewCoins(sdk.NewCoin(v1beta1.PylonsCoinDenom, sdk.NewInt(45000000))),
		},
		{
			desc: "Valid3",
			request: &v1beta1.MsgGoogleInAppPurchaseGetCoins{
			...
			balance: sdk.NewCoins(sdk.NewCoin(v1beta1.PylonsCoinDenom, sdk.NewInt(105000000))),
		},
		{
			...
			err: sdkerrors.Wrap(v1beta1.ErrReceiptAlreadyUsed, "the Google IAP order ID is already being used"),
		},
	} {
		tc := tc
