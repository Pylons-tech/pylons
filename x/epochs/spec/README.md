...
This module is modified from the `x/epochs` module of [Osmosis](https://github.com/osmosis-labs/osmosis).  See the [LICENSE](../LICENSE) for more details about usage. 
