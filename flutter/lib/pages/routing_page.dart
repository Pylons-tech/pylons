  ...
  Future<void> _loadWallets() async {
    ...
    if (store.loadWalletsFailure.value == null) {
      //Loads the last used wallet.
        ...
        var currentWallet = prefs.getString("pylons:current_wallet");
        if (currentWallet==null){
          Navigator.of(context).push(MaterialPageRoute(builder: (_) => PresentingOnboardPage()));
        }else{
          PylonsApp.currentWallet = PylonsApp.walletsStore.wallets.value.firstWhere((wallet) => wallet.name==currentWallet);
