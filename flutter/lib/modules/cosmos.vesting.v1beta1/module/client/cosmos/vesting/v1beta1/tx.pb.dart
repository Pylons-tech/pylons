...
class MsgCreateVestingAccount extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgCreateVestingAccount',
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  MsgCreateVestingAccount copyWith(void Function(MsgCreateVestingAccount) updates) =>
      super.copyWith((message) => updates(message as MsgCreateVestingAccount)) as MsgCreateVestingAccount; // ignore: deprecated_member_use
...
class MsgCreateVestingAccountResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgCreateVestingAccountResponse',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.vesting.v1beta1'), createEmptyInstance: create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  MsgCreateVestingAccountResponse copyWith(void Function(MsgCreateVestingAccountResponse) updates) =>
      super.copyWith((message) => updates(message as MsgCreateVestingAccountResponse)) as MsgCreateVestingAccountResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
