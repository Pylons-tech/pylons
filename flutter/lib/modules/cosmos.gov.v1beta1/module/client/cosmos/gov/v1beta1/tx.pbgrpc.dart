...
import 'package:pylons_wallet/modules/cosmos.gov.v1beta1/module/client/cosmos/gov/v1beta1/tx.pb.dart' as $1;

export 'tx.pb.dart';

class MsgClient extends $grpc.Client {
  static final _$submitProposal = $grpc.ClientMethod<$1.MsgSubmitProposal, $1.MsgSubmitProposalResponse>(
      '/cosmos.gov.v1beta1.Msg/SubmitProposal', ($1.MsgSubmitProposal value) => value.writeToBuffer(), ($core.List<$core.int> value) => $1.MsgSubmitProposalResponse.fromBuffer(value));
  static final _$vote = $grpc.ClientMethod<$1.MsgVote, $1.MsgVoteResponse>(
      '/cosmos.gov.v1beta1.Msg/Vote', ($1.MsgVote value) => value.writeToBuffer(), ($core.List<$core.int> value) => $1.MsgVoteResponse.fromBuffer(value));
  static final _$voteWeighted = $grpc.ClientMethod<$1.MsgVoteWeighted, $1.MsgVoteWeightedResponse>(
      '/cosmos.gov.v1beta1.Msg/VoteWeighted', ($1.MsgVoteWeighted value) => value.writeToBuffer(), ($core.List<$core.int> value) => $1.MsgVoteWeightedResponse.fromBuffer(value));
  static final _$deposit = $grpc.ClientMethod<$1.MsgDeposit, $1.MsgDepositResponse>(
      '/cosmos.gov.v1beta1.Msg/Deposit', ($1.MsgDeposit value) => value.writeToBuffer(), ($core.List<$core.int> value) => $1.MsgDepositResponse.fromBuffer(value));
...
abstract class MsgServiceBase extends $grpc.Service {
  ...
  MsgServiceBase() {
    $addMethod($grpc.ServiceMethod<$1.MsgSubmitProposal, $1.MsgSubmitProposalResponse>(
        'SubmitProposal', submitProposal_Pre, false, false, ($core.List<$core.int> value) => $1.MsgSubmitProposal.fromBuffer(value), ($1.MsgSubmitProposalResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.MsgVote, $1.MsgVoteResponse>(
        'Vote', vote_Pre, false, false, ($core.List<$core.int> value) => $1.MsgVote.fromBuffer(value), ($1.MsgVoteResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.MsgVoteWeighted, $1.MsgVoteWeightedResponse>(
        'VoteWeighted', voteWeighted_Pre, false, false, ($core.List<$core.int> value) => $1.MsgVoteWeighted.fromBuffer(value), ($1.MsgVoteWeightedResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.MsgDeposit, $1.MsgDepositResponse>(
        'Deposit', deposit_Pre, false, false, ($core.List<$core.int> value) => $1.MsgDeposit.fromBuffer(value), ($1.MsgDepositResponse value) => value.writeToBuffer()));
  }
