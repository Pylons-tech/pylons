...
import 'package:pylons_wallet/modules/cosmos.evidence.v1beta1/module/client/cosmos/evidence/v1beta1/tx.pb.dart' as $1;
export 'tx.pb.dart';

class MsgClient extends $grpc.Client {
  static final _$submitEvidence = $grpc.ClientMethod<$1.MsgSubmitEvidence, $1.MsgSubmitEvidenceResponse>(
      '/cosmos.evidence.v1beta1.Msg/SubmitEvidence', ($1.MsgSubmitEvidence value) => value.writeToBuffer(), ($core.List<$core.int> value) => $1.MsgSubmitEvidenceResponse.fromBuffer(value));
...
abstract class MsgServiceBase extends $grpc.Service {
  ...
  MsgServiceBase() {
    $addMethod($grpc.ServiceMethod<$1.MsgSubmitEvidence, $1.MsgSubmitEvidenceResponse>(
        'SubmitEvidence', submitEvidence_Pre, false, false, ($core.List<$core.int> value) => $1.MsgSubmitEvidence.fromBuffer(value), ($1.MsgSubmitEvidenceResponse value) => value.writeToBuffer()));
  }
