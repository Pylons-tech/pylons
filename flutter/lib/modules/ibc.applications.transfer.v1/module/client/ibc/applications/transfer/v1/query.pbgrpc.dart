...
import 'package:pylons_wallet/modules/ibc.applications.transfer.v1/module/client/ibc/applications/transfer/v1/query.pb.dart' as $0;
export 'query.pb.dart';

class QueryClient extends $grpc.Client {
  static final _$denomTrace = $grpc.ClientMethod<$0.QueryDenomTraceRequest, $0.QueryDenomTraceResponse>(
      '/ibc.applications.transfer.v1.Query/DenomTrace', ($0.QueryDenomTraceRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryDenomTraceResponse.fromBuffer(value));
  static final _$denomTraces = $grpc.ClientMethod<$0.QueryDenomTracesRequest, $0.QueryDenomTracesResponse>(
      '/ibc.applications.transfer.v1.Query/DenomTraces', ($0.QueryDenomTracesRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryDenomTracesResponse.fromBuffer(value));
  static final _$params = $grpc.ClientMethod<$0.QueryParamsRequest, $0.QueryParamsResponse>(
      '/ibc.applications.transfer.v1.Query/Params', ($0.QueryParamsRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryParamsResponse.fromBuffer(value));
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.QueryDenomTraceRequest, $0.QueryDenomTraceResponse>(
        'DenomTrace', denomTrace_Pre, false, false, ($core.List<$core.int> value) => $0.QueryDenomTraceRequest.fromBuffer(value), ($0.QueryDenomTraceResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.QueryDenomTracesRequest, $0.QueryDenomTracesResponse>(
        'DenomTraces', denomTraces_Pre, false, false, ($core.List<$core.int> value) => $0.QueryDenomTracesRequest.fromBuffer(value), ($0.QueryDenomTracesResponse value) => value.writeToBuffer()));
