...
import 'package:pylons_wallet/modules/cosmos.bank.v1beta1/module/client/cosmos/bank/v1beta1/query.pb.dart' as $0;
export 'query.pb.dart';

class QueryClient extends $grpc.Client {
  static final _$balance = $grpc.ClientMethod<$0.QueryBalanceRequest, $0.QueryBalanceResponse>(
      '/cosmos.bank.v1beta1.Query/Balance', ($0.QueryBalanceRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryBalanceResponse.fromBuffer(value));
  static final _$allBalances = $grpc.ClientMethod<$0.QueryAllBalancesRequest, $0.QueryAllBalancesResponse>(
      '/cosmos.bank.v1beta1.Query/AllBalances', ($0.QueryAllBalancesRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryAllBalancesResponse.fromBuffer(value));
  static final _$totalSupply = $grpc.ClientMethod<$0.QueryTotalSupplyRequest, $0.QueryTotalSupplyResponse>(
      '/cosmos.bank.v1beta1.Query/TotalSupply', ($0.QueryTotalSupplyRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryTotalSupplyResponse.fromBuffer(value));
  static final _$supplyOf = $grpc.ClientMethod<$0.QuerySupplyOfRequest, $0.QuerySupplyOfResponse>(
      '/cosmos.bank.v1beta1.Query/SupplyOf', ($0.QuerySupplyOfRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QuerySupplyOfResponse.fromBuffer(value));
  static final _$params = $grpc.ClientMethod<$0.QueryParamsRequest, $0.QueryParamsResponse>(
      '/cosmos.bank.v1beta1.Query/Params', ($0.QueryParamsRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryParamsResponse.fromBuffer(value));
  static final _$denomMetadata = $grpc.ClientMethod<$0.QueryDenomMetadataRequest, $0.QueryDenomMetadataResponse>(
      '/cosmos.bank.v1beta1.Query/DenomMetadata', ($0.QueryDenomMetadataRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryDenomMetadataResponse.fromBuffer(value));
  static final _$denomsMetadata = $grpc.ClientMethod<$0.QueryDenomsMetadataRequest, $0.QueryDenomsMetadataResponse>(
      '/cosmos.bank.v1beta1.Query/DenomsMetadata', ($0.QueryDenomsMetadataRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryDenomsMetadataResponse.fromBuffer(value));
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.QueryBalanceRequest, $0.QueryBalanceResponse>(
        'Balance', balance_Pre, false, false, ($core.List<$core.int> value) => $0.QueryBalanceRequest.fromBuffer(value), ($0.QueryBalanceResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.QueryAllBalancesRequest, $0.QueryAllBalancesResponse>(
        'AllBalances', allBalances_Pre, false, false, ($core.List<$core.int> value) => $0.QueryAllBalancesRequest.fromBuffer(value), ($0.QueryAllBalancesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.QueryTotalSupplyRequest, $0.QueryTotalSupplyResponse>(
        'TotalSupply', totalSupply_Pre, false, false, ($core.List<$core.int> value) => $0.QueryTotalSupplyRequest.fromBuffer(value), ($0.QueryTotalSupplyResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.QuerySupplyOfRequest, $0.QuerySupplyOfResponse>(
        'SupplyOf', supplyOf_Pre, false, false, ($core.List<$core.int> value) => $0.QuerySupplyOfRequest.fromBuffer(value), ($0.QuerySupplyOfResponse value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$0.QueryDenomMetadataRequest, $0.QueryDenomMetadataResponse>('DenomMetadata', denomMetadata_Pre, false, false,
        ($core.List<$core.int> value) => $0.QueryDenomMetadataRequest.fromBuffer(value), ($0.QueryDenomMetadataResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.QueryDenomsMetadataRequest, $0.QueryDenomsMetadataResponse>('DenomsMetadata', denomsMetadata_Pre, false, false,
        ($core.List<$core.int> value) => $0.QueryDenomsMetadataRequest.fromBuffer(value), ($0.QueryDenomsMetadataResponse value) => value.writeToBuffer()));
  }
