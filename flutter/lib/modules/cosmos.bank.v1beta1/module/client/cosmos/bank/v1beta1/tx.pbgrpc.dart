...
import 'package:pylons_wallet/modules/cosmos.bank.v1beta1/module/client/cosmos/bank/v1beta1/tx.pb.dart' as $1;
export 'tx.pb.dart';

class MsgClient extends $grpc.Client {
  static final _$send = $grpc.ClientMethod<$1.MsgSend, $1.MsgSendResponse>(
      '/cosmos.bank.v1beta1.Msg/Send', ($1.MsgSend value) => value.writeToBuffer(), ($core.List<$core.int> value) => $1.MsgSendResponse.fromBuffer(value));
  static final _$multiSend = $grpc.ClientMethod<$1.MsgMultiSend, $1.MsgMultiSendResponse>(
      '/cosmos.bank.v1beta1.Msg/MultiSend', ($1.MsgMultiSend value) => value.writeToBuffer(), ($core.List<$core.int> value) => $1.MsgMultiSendResponse.fromBuffer(value));
...
abstract class MsgServiceBase extends $grpc.Service {
  ...
  MsgServiceBase() {
    $addMethod($grpc.ServiceMethod<$1.MsgSend, $1.MsgSendResponse>(
        'Send', send_Pre, false, false, ($core.List<$core.int> value) => $1.MsgSend.fromBuffer(value), ($1.MsgSendResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.MsgMultiSend, $1.MsgMultiSendResponse>(
        'MultiSend', multiSend_Pre, false, false, ($core.List<$core.int> value) => $1.MsgMultiSend.fromBuffer(value), ($1.MsgMultiSendResponse value) => value.writeToBuffer()));
  }
