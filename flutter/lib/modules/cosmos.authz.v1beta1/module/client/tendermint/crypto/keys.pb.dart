...
class PublicKey extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, PublicKey_Sum> _PublicKey_SumByTag = {1: PublicKey_Sum.ed25519, 2: PublicKey_Sum.secp256k1, 0: PublicKey_Sum.notSet};
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PublicKey',
