...
import 'package:pylons_wallet/modules/cosmos.authz.v1beta1/module/client/cosmos/base/query/v1beta1/pagination.pb.dart' as $6;
...
class QueryGrantsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryGrantsRequest',
...
class QueryGrantsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryGrantsResponse',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.authz.v1beta1'), createEmptyInstance: create)
  ...
  QueryGrantsResponse copyWith(void Function(QueryGrantsResponse) updates) =>
      super.copyWith((message) => updates(message as QueryGrantsResponse)) as QueryGrantsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
