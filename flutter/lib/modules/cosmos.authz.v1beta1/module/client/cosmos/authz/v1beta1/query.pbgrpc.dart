...
import 'package:pylons_wallet/modules/cosmos.authz.v1beta1/module/client/cosmos/authz/v1beta1/query.pb.dart' as $0;
export 'query.pb.dart';

class QueryClient extends $grpc.Client {
  static final _$grants = $grpc.ClientMethod<$0.QueryGrantsRequest, $0.QueryGrantsResponse>(
      '/cosmos.authz.v1beta1.Query/Grants', ($0.QueryGrantsRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryGrantsResponse.fromBuffer(value));
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.QueryGrantsRequest, $0.QueryGrantsResponse>(
        'Grants', grants_Pre, false, false, ($core.List<$core.int> value) => $0.QueryGrantsRequest.fromBuffer(value), ($0.QueryGrantsResponse value) => value.writeToBuffer()));
  }
