...
import 'package:pylons_wallet/modules/cosmos.slashing.v1beta1/module/client/cosmos/slashing/v1beta1/tx.pb.dart' as $1;
export 'tx.pb.dart';

class MsgClient extends $grpc.Client {
  static final _$unjail = $grpc.ClientMethod<$1.MsgUnjail, $1.MsgUnjailResponse>(
      '/cosmos.slashing.v1beta1.Msg/Unjail', ($1.MsgUnjail value) => value.writeToBuffer(), ($core.List<$core.int> value) => $1.MsgUnjailResponse.fromBuffer(value));
...
abstract class MsgServiceBase extends $grpc.Service {
  ...
  MsgServiceBase() {
    $addMethod($grpc.ServiceMethod<$1.MsgUnjail, $1.MsgUnjailResponse>(
        'Unjail', unjail_Pre, false, false, ($core.List<$core.int> value) => $1.MsgUnjail.fromBuffer(value), ($1.MsgUnjailResponse value) => value.writeToBuffer()));
  }
