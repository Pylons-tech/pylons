...
import 'package:pylons_wallet/modules/cosmos.feegrant.v1beta1/module/client/cosmos/base/v1beta1/coin.pb.dart' as $2;
import 'package:pylons_wallet/modules/cosmos.feegrant.v1beta1/module/client/google/protobuf/any.pb.dart' as $5;
import 'package:pylons_wallet/modules/cosmos.feegrant.v1beta1/module/client/google/protobuf/duration.pb.dart' as $4;
import 'package:pylons_wallet/modules/cosmos.feegrant.v1beta1/module/client/google/protobuf/timestamp.pb.dart' as $3;

class BasicAllowance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BasicAllowance',
...
class PeriodicAllowance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PeriodicAllowance',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.feegrant.v1beta1'), createEmptyInstance: create)
...
class AllowedMsgAllowance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AllowedMsgAllowance',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.feegrant.v1beta1'), createEmptyInstance: create)
  ...
  AllowedMsgAllowance copyWith(void Function(AllowedMsgAllowance) updates) =>
      super.copyWith((message) => updates(message as AllowedMsgAllowance)) as AllowedMsgAllowance; // ignore: deprecated_member_use
  @override
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Grant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Grant',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.feegrant.v1beta1'), createEmptyInstance: create)
