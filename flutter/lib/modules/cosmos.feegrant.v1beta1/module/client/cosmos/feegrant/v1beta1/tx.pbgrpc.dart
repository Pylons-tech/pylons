...
import 'package:pylons_wallet/modules/cosmos.feegrant.v1beta1/module/client/cosmos/feegrant/v1beta1/tx.pb.dart' as $1;
export 'tx.pb.dart';

class MsgClient extends $grpc.Client {
  static final _$grantAllowance = $grpc.ClientMethod<$1.MsgGrantAllowance, $1.MsgGrantAllowanceResponse>(
      '/cosmos.feegrant.v1beta1.Msg/GrantAllowance', ($1.MsgGrantAllowance value) => value.writeToBuffer(), ($core.List<$core.int> value) => $1.MsgGrantAllowanceResponse.fromBuffer(value));
  static final _$revokeAllowance = $grpc.ClientMethod<$1.MsgRevokeAllowance, $1.MsgRevokeAllowanceResponse>(
      '/cosmos.feegrant.v1beta1.Msg/RevokeAllowance', ($1.MsgRevokeAllowance value) => value.writeToBuffer(), ($core.List<$core.int> value) => $1.MsgRevokeAllowanceResponse.fromBuffer(value));
...
abstract class MsgServiceBase extends $grpc.Service {
  ...
  MsgServiceBase() {
    $addMethod($grpc.ServiceMethod<$1.MsgGrantAllowance, $1.MsgGrantAllowanceResponse>(
        'GrantAllowance', grantAllowance_Pre, false, false, ($core.List<$core.int> value) => $1.MsgGrantAllowance.fromBuffer(value), ($1.MsgGrantAllowanceResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.MsgRevokeAllowance, $1.MsgRevokeAllowanceResponse>('RevokeAllowance', revokeAllowance_Pre, false, false,
        ($core.List<$core.int> value) => $1.MsgRevokeAllowance.fromBuffer(value), ($1.MsgRevokeAllowanceResponse value) => value.writeToBuffer()));
  }
