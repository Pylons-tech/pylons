...
class StakeAuthorization_Validators extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StakeAuthorization.Validators',
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  StakeAuthorization_Validators copyWith(void Function(StakeAuthorization_Validators) updates) =>
      super.copyWith((message) => updates(message as StakeAuthorization_Validators)) as StakeAuthorization_Validators; // ignore: deprecated_member_use
...
class StakeAuthorization extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StakeAuthorization',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.staking.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ...
    ..e<AuthorizationType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorizationType', $pb.PbFieldType.OE,
        defaultOrMaker: AuthorizationType.AUTHORIZATION_TYPE_UNSPECIFIED, valueOf: AuthorizationType.valueOf, enumValues: AuthorizationType.values)
    ..hasRequiredFields = false;
