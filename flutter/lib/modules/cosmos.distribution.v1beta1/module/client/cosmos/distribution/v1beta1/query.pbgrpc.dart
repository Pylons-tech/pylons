...
import 'package:pylons_wallet/modules/cosmos.distribution.v1beta1/module/client/cosmos/distribution/v1beta1/query.pb.dart' as $0;
export 'query.pb.dart';

class QueryClient extends $grpc.Client {
  static final _$params = $grpc.ClientMethod<$0.QueryParamsRequest, $0.QueryParamsResponse>(
      '/cosmos.distribution.v1beta1.Query/Params', ($0.QueryParamsRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryParamsResponse.fromBuffer(value));
  ...
  static final _$validatorCommission = $grpc.ClientMethod<$0.QueryValidatorCommissionRequest, $0.QueryValidatorCommissionResponse>('/cosmos.distribution.v1beta1.Query/ValidatorCommission',
      ($0.QueryValidatorCommissionRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryValidatorCommissionResponse.fromBuffer(value));
  static final _$validatorSlashes = $grpc.ClientMethod<$0.QueryValidatorSlashesRequest, $0.QueryValidatorSlashesResponse>('/cosmos.distribution.v1beta1.Query/ValidatorSlashes',
      ($0.QueryValidatorSlashesRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryValidatorSlashesResponse.fromBuffer(value));
  static final _$delegationRewards = $grpc.ClientMethod<$0.QueryDelegationRewardsRequest, $0.QueryDelegationRewardsResponse>('/cosmos.distribution.v1beta1.Query/DelegationRewards',
      ($0.QueryDelegationRewardsRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryDelegationRewardsResponse.fromBuffer(value));
  static final _$delegationTotalRewards = $grpc.ClientMethod<$0.QueryDelegationTotalRewardsRequest, $0.QueryDelegationTotalRewardsResponse>('/cosmos.distribution.v1beta1.Query/DelegationTotalRewards',
      ($0.QueryDelegationTotalRewardsRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryDelegationTotalRewardsResponse.fromBuffer(value));
  static final _$delegatorValidators = $grpc.ClientMethod<$0.QueryDelegatorValidatorsRequest, $0.QueryDelegatorValidatorsResponse>('/cosmos.distribution.v1beta1.Query/DelegatorValidators',
  ...
  static final _$communityPool = $grpc.ClientMethod<$0.QueryCommunityPoolRequest, $0.QueryCommunityPoolResponse>('/cosmos.distribution.v1beta1.Query/CommunityPool',
      ($0.QueryCommunityPoolRequest value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.QueryCommunityPoolResponse.fromBuffer(value));
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.QueryValidatorOutstandingRewardsRequest, $0.QueryValidatorOutstandingRewardsResponse>('ValidatorOutstandingRewards', validatorOutstandingRewards_Pre, false,
        false, ($core.List<$core.int> value) => $0.QueryValidatorOutstandingRewardsRequest.fromBuffer(value), ($0.QueryValidatorOutstandingRewardsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.QueryValidatorCommissionRequest, $0.QueryValidatorCommissionResponse>('ValidatorCommission', validatorCommission_Pre, false, false,
        ($core.List<$core.int> value) => $0.QueryValidatorCommissionRequest.fromBuffer(value), ($0.QueryValidatorCommissionResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.QueryValidatorSlashesRequest, $0.QueryValidatorSlashesResponse>('ValidatorSlashes', validatorSlashes_Pre, false, false,
        ($core.List<$core.int> value) => $0.QueryValidatorSlashesRequest.fromBuffer(value), ($0.QueryValidatorSlashesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.QueryDelegationRewardsRequest, $0.QueryDelegationRewardsResponse>('DelegationRewards', delegationRewards_Pre, false, false,
        ($core.List<$core.int> value) => $0.QueryDelegationRewardsRequest.fromBuffer(value), ($0.QueryDelegationRewardsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.QueryDelegationTotalRewardsRequest, $0.QueryDelegationTotalRewardsResponse>('DelegationTotalRewards', delegationTotalRewards_Pre, false, false,
        ($core.List<$core.int> value) => $0.QueryDelegationTotalRewardsRequest.fromBuffer(value), ($0.QueryDelegationTotalRewardsResponse value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$0.QueryDelegatorWithdrawAddressRequest, $0.QueryDelegatorWithdrawAddressResponse>('DelegatorWithdrawAddress', delegatorWithdrawAddress_Pre, false, false,
        ($core.List<$core.int> value) => $0.QueryDelegatorWithdrawAddressRequest.fromBuffer(value), ($0.QueryDelegatorWithdrawAddressResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.QueryCommunityPoolRequest, $0.QueryCommunityPoolResponse>('CommunityPool', communityPool_Pre, false, false,
        ($core.List<$core.int> value) => $0.QueryCommunityPoolRequest.fromBuffer(value), ($0.QueryCommunityPoolResponse value) => value.writeToBuffer()));
  }
