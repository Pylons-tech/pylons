...
import 'package:pylons_wallet/modules/cosmos.distribution.v1beta1/module/client/cosmos/distribution/v1beta1/tx.pb.dart' as $1;
export 'tx.pb.dart';

class MsgClient extends $grpc.Client {
  static final _$setWithdrawAddress = $grpc.ClientMethod<$1.MsgSetWithdrawAddress, $1.MsgSetWithdrawAddressResponse>('/cosmos.distribution.v1beta1.Msg/SetWithdrawAddress',
      ($1.MsgSetWithdrawAddress value) => value.writeToBuffer(), ($core.List<$core.int> value) => $1.MsgSetWithdrawAddressResponse.fromBuffer(value));
  static final _$withdrawDelegatorReward = $grpc.ClientMethod<$1.MsgWithdrawDelegatorReward, $1.MsgWithdrawDelegatorRewardResponse>('/cosmos.distribution.v1beta1.Msg/WithdrawDelegatorReward',
      ($1.MsgWithdrawDelegatorReward value) => value.writeToBuffer(), ($core.List<$core.int> value) => $1.MsgWithdrawDelegatorRewardResponse.fromBuffer(value));
  ...
  static final _$fundCommunityPool = $grpc.ClientMethod<$1.MsgFundCommunityPool, $1.MsgFundCommunityPoolResponse>('/cosmos.distribution.v1beta1.Msg/FundCommunityPool',
      ($1.MsgFundCommunityPool value) => value.writeToBuffer(), ($core.List<$core.int> value) => $1.MsgFundCommunityPoolResponse.fromBuffer(value));
...
abstract class MsgServiceBase extends $grpc.Service {
  ...
  MsgServiceBase() {
    $addMethod($grpc.ServiceMethod<$1.MsgSetWithdrawAddress, $1.MsgSetWithdrawAddressResponse>('SetWithdrawAddress', setWithdrawAddress_Pre, false, false,
        ($core.List<$core.int> value) => $1.MsgSetWithdrawAddress.fromBuffer(value), ($1.MsgSetWithdrawAddressResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.MsgWithdrawDelegatorReward, $1.MsgWithdrawDelegatorRewardResponse>('WithdrawDelegatorReward', withdrawDelegatorReward_Pre, false, false,
        ($core.List<$core.int> value) => $1.MsgWithdrawDelegatorReward.fromBuffer(value), ($1.MsgWithdrawDelegatorRewardResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.MsgWithdrawValidatorCommission, $1.MsgWithdrawValidatorCommissionResponse>('WithdrawValidatorCommission', withdrawValidatorCommission_Pre, false, false,
        ($core.List<$core.int> value) => $1.MsgWithdrawValidatorCommission.fromBuffer(value), ($1.MsgWithdrawValidatorCommissionResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.MsgFundCommunityPool, $1.MsgFundCommunityPoolResponse>('FundCommunityPool', fundCommunityPool_Pre, false, false,
        ($core.List<$core.int> value) => $1.MsgFundCommunityPool.fromBuffer(value), ($1.MsgFundCommunityPoolResponse value) => value.writeToBuffer()));
  }
