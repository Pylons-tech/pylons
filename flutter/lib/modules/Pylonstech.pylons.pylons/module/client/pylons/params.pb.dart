...
class GoogleInAppPurchasePackage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GoogleInAppPurchasePackage',
  ...
  GoogleInAppPurchasePackage copyWith(void Function(GoogleInAppPurchasePackage) updates) =>
      super.copyWith((message) => updates(message as GoogleInAppPurchasePackage)) as GoogleInAppPurchasePackage; // ignore: deprecated_member_use
...
class CoinIssuer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CoinIssuer',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'CoinDenom', protoName: 'CoinDenom')
    ..pc<GoogleInAppPurchasePackage>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Packages', $pb.PbFieldType.PM,
        protoName: 'Packages', subBuilder: GoogleInAppPurchasePackage.create)
...
class Params extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Params',
      package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minNameFieldLength', $pb.PbFieldType.OU6,
        protoName: 'minNameFieldLength', defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minDescriptionFieldLength', $pb.PbFieldType.OU6,
        protoName: 'minDescriptionFieldLength', defaultOrMaker: $fixnum.Int64.ZERO)
