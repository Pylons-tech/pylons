...
class MsgClient extends $grpc.Client {
  static final _$verifyInvariant = $grpc.ClientMethod<$0.MsgVerifyInvariant, $0.MsgVerifyInvariantResponse>(
      '/cosmos.crisis.v1beta1.Msg/VerifyInvariant', ($0.MsgVerifyInvariant value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.MsgVerifyInvariantResponse.fromBuffer(value));
...
abstract class MsgServiceBase extends $grpc.Service {
  ...
  MsgServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.MsgVerifyInvariant, $0.MsgVerifyInvariantResponse>('VerifyInvariant', verifyInvariant_Pre, false, false,
        ($core.List<$core.int> value) => $0.MsgVerifyInvariant.fromBuffer(value), ($0.MsgVerifyInvariantResponse value) => value.writeToBuffer()));
  }
