                      ...
                      Row(children: [
                        InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: provider.isFreeDrop == true
                                  ? EaselAppTheme.kBlue
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            height: 30.h,
                            decoration: BoxDecoration(
                              color: provider.isFreeDrop == false
                                  ? EaselAppTheme.kBlue
                                  : EaselAppTheme.kTransparent,
                              border: Border.all(
                                  color: provider.isFreeDrop == false
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            EaselPriceInputField(
                              key: ValueKey(
                                  "${provider.selectedDenom.name}-amount"),
                              inputFormatters: [
                        ...
                        validator: (value) {
                          ...
                          if (int.parse(value) > kMaxRoyalty) {
                            _royaltiesFieldError.value =
                                "$kRoyaltyRangeText $kMinRoyalty-$kMaxRoyalty %";
                            return;
                          }
                          _royaltiesFieldError.value = '';
                          return null;
                        ...
                        validator: (value) {
                          ...
                          if (int.parse(value.replaceAll(",", "")) <
                            ...
                            _noOfEditionsFieldError.value =
                                "$kMinIsText $kMinEditionValue";
                            return;
                          }
                          if (int.parse(value.replaceAll(",", "")) >
                              kMaxEdition) {
                            _noOfEditionsFieldError.value =
                                "$kMaxIsTextText $kMaxEdition";
                            return;
                          }
                          _noOfEditionsFieldError.value = '';
                          return null;
