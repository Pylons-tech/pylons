...
class NFT extends Equatable {
  ...
  static Future<NFT?> fromItem(Item item) async {
    ...
    return NFT(
      ...
      thumbnailUrl: item.strings
          .firstWhere(
            (strKeyValue) => strKeyValue.key == kThumbnailUrl,
      ...
      creator: item.strings
          .firstWhere(
            (strKeyValue) => strKeyValue.key == kCreator,
            orElse: () => StringKeyValue(key: kCreator, value: ""),
          )
          .value,
      cid: item.strings
          .firstWhere(
            (strKeyValue) => strKeyValue.key == kCID,
            orElse: () => StringKeyValue(key: kCID, value: ""),
          )
          .value,
      appType: item.strings
          .firstWhere(
            (strKeyValue) => strKeyValue.key == kAppType,
            orElse: () => StringKeyValue(key: kAppType, value: ""),
          )
          .value,
      width: item.longs
          .firstWhere(
            (longKeyValue) => longKeyValue.key == kWidth,
      ...
      height: item.longs
          .firstWhere(
            (longKeyValue) => longKeyValue.key == kHeight,
      ...
      duration: item.longs
          .firstWhere(
            (longKeyValue) => longKeyValue.key == kDuration,
      ...
      realWorld: item.strings
              .firstWhere(
                (strKeyValue) => strKeyValue.key == kRealWorld,
  ...
  static String getFileSize(Item item) {
    return item.strings.firstWhereOrNull((strKeyValue) => strKeyValue.key == kFileSize)?.value ?? "";
  }
  ...
  factory NFT.fromRecipe(Recipe recipe) {
    ...
    return NFT(
      ...
      name: recipe.entries.itemOutputs.firstOrNull?.strings
              .firstWhere(
                (strKeyValue) => strKeyValue.key == kName,
                orElse: () => StringParam(),
              )
              .value ??
          "",
      url: recipe.entries.itemOutputs.firstOrNull?.strings
              .firstWhere(
                (strKeyValue) => strKeyValue.key == kNFTURL,
                orElse: () => StringParam(),
              )
              .value
              .changeDomain() ??
      ...
      description: recipe.entries.itemOutputs.firstOrNull?.strings
              .firstWhere(
                (strKeyValue) => strKeyValue.key == kDescription,
                orElse: () => StringParam(),
              )
              .value ??
          "",
      fileSize: recipe.entries.itemOutputs.firstOrNull?.strings
              .firstWhere(
                (strKeyValue) => strKeyValue.key == kFileSize,
                orElse: () => StringParam(),
              )
              .value ??
          "",
      ...
      assetType: recipe.entries.itemOutputs.firstOrNull?.strings
              .firstWhere(
                (strKeyValue) => strKeyValue.key == kNftFormat,
                orElse: () => StringParam(),
              )
              .value
              .toAssetTypeEnum() ??
