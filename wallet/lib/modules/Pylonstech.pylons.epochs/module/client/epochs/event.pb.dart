...
class EventEndEpoch extends $pb.GeneratedMessage {
  ...
  factory EventEndEpoch.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory EventEndEpoch.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  EventEndEpoch copyWith(void Function(EventEndEpoch) updates) =>
      super.copyWith((message) => updates(message as EventEndEpoch))
          as EventEndEpoch; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static EventEndEpoch create() => EventEndEpoch._();
  EventEndEpoch createEmptyInstance() => create();
  static $pb.PbList<EventEndEpoch> createRepeated() =>
      $pb.PbList<EventEndEpoch>();
  @$core.pragma('dart2js:noInline')
  static EventEndEpoch getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<EventEndEpoch>(create);
...
class EventBeginEpoch extends $pb.GeneratedMessage {
  ...
  factory EventBeginEpoch.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory EventBeginEpoch.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  EventBeginEpoch copyWith(void Function(EventBeginEpoch) updates) =>
      super.copyWith((message) => updates(message as EventBeginEpoch))
          as EventBeginEpoch; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static EventBeginEpoch create() => EventBeginEpoch._();
  EventBeginEpoch createEmptyInstance() => create();
  static $pb.PbList<EventBeginEpoch> createRepeated() =>
      $pb.PbList<EventBeginEpoch>();
  @$core.pragma('dart2js:noInline')
  static EventBeginEpoch getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<EventBeginEpoch>(create);
