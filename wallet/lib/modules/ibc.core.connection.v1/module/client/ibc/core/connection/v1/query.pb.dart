...
class QueryConnectionResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$4.ConnectionEnd>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'connection',
        subBuilder: $4.ConnectionEnd.create)
  ...
  @$pb.TagNumber(1)
  set connection($4.ConnectionEnd v) {
    setField(1, v);
  }
...
class QueryConnectionsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$10.PageRequest>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'pagination',
        subBuilder: $10.PageRequest.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  set pagination($10.PageRequest v) {
    setField(1, v);
  }
...
class QueryConnectionsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$10.PageResponse>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'pagination',
        subBuilder: $10.PageResponse.create)
    ..aOM<$9.Height>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(2)
  set pagination($10.PageResponse v) {
    setField(2, v);
  }
...
class QueryConnectionClientStateResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'ibc.core.connection.v1'),
      createEmptyInstance: create)
    ..aOM<$9.IdentifiedClientState>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'identifiedClientState',
        subBuilder: $9.IdentifiedClientState.create)
    ..a<$core.List<$core.int>>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(1)
  set identifiedClientState($9.IdentifiedClientState v) {
    setField(1, v);
  }
