  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$14.SignMode>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'mode',
        $pb.PbFieldType.OE,
        defaultOrMaker: $14.SignMode.SIGN_MODE_UNSPECIFIED,
        valueOf: $14.SignMode.valueOf,
        enumValues: $14.SignMode.values)
    ..hasRequiredFields = false;
...
class ModeInfo_Multi extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.tx.v1beta1'),
      createEmptyInstance: create)
    ..aOM<$12.CompactBitArray>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'bitarray',
        subBuilder: $12.CompactBitArray.create)
    ..pc<ModeInfo>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(1)
  set bitarray($12.CompactBitArray v) {
    setField(1, v);
  }
