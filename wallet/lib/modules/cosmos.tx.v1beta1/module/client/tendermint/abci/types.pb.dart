...
class ConsensusParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$10.EvidenceParams>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'evidence',
        subBuilder: $10.EvidenceParams.create)
    ..aOM<$10.ValidatorParams>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'validator',
        subBuilder: $10.ValidatorParams.create)
    ..aOM<$10.VersionParams>(
        4,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'version',
        subBuilder: $10.VersionParams.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  set evidence($10.EvidenceParams v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(3)
  set validator($10.ValidatorParams v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(4)
  set version($10.VersionParams v) {
    setField(4, v);
  }
