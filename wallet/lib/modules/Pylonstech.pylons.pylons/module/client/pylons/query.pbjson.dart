...
const QueryListSignUpByReferee$json = const {
...
final $typed_data.Uint8List queryListSignUpByRefereeDescriptor = $convert.base64Decode('ChhRdWVyeUxpc3RTaWduVXBCeVJlZmVyZWUSGAoHY3JlYXRvchgBIAEoCVIHY3JlYXRvcg==');
@$core.Deprecated('Use queryListSignUpByRefereeResponseDescriptor instead')
const QueryListSignUpByRefereeResponse$json = const {
  '1': 'QueryListSignUpByRefereeResponse',
  '2': const [
    const {'1': 'signup', '3': 1, '4': 1, '5': 11, '6': '.pylons.pylons.ReferralKV', '10': 'signup'},
  ],
};

/// Descriptor for `QueryListSignUpByRefereeResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryListSignUpByRefereeResponseDescriptor = $convert.base64Decode('CiBRdWVyeUxpc3RTaWduVXBCeVJlZmVyZWVSZXNwb25zZRIxCgZzaWdudXAYASABKAsyGS5weWxvbnMucHlsb25zLlJlZmVycmFsS1ZSBnNpZ251cA==');
...
final $typed_data.Uint8List queryListTradesByCreatorResponseDescriptor = $convert.base64Decode('CiBRdWVyeUxpc3RUcmFkZXNCeUNyZWF0b3JSZXNwb25zZRIyCgZ0cmFkZXMYASADKAsyFC5weWxvbnMucHlsb25zLlRyYWRlQgTI3h8AUgZ0cmFkZXMSRwoKcGFnaW5hdGlvbhgCIAEoCzInLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlc3BvbnNlUgpwYWdpbmF0aW9uOgiIoB8A6KAfAA==');
@$core.Deprecated('Use queryGetItemHistoryRequestDescriptor instead')
const QueryGetItemHistoryRequest$json = const {
  '1': 'QueryGetItemHistoryRequest',
  '2': const [
    const {'1': 'cookbook_id', '3': 1, '4': 1, '5': 9, '10': 'cookbookId'},
    const {'1': 'item_id', '3': 2, '4': 1, '5': 9, '10': 'itemId'},
    const {'1': 'minted_number', '3': 3, '4': 1, '5': 9, '10': 'mintedNumber'},
  ],
};

/// Descriptor for `QueryGetItemHistoryRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetItemHistoryRequestDescriptor = $convert.base64Decode('ChpRdWVyeUdldEl0ZW1IaXN0b3J5UmVxdWVzdBIfCgtjb29rYm9va19pZBgBIAEoCVIKY29va2Jvb2tJZBIXCgdpdGVtX2lkGAIgASgJUgZpdGVtSWQSIwoNbWludGVkX251bWJlchgDIAEoCVIMbWludGVkTnVtYmVy');
@$core.Deprecated('Use queryGetItemHistoryResponseDescriptor instead')
const QueryGetItemHistoryResponse$json = const {
  '1': 'QueryGetItemHistoryResponse',
  '2': const [
    const {'1': 'history', '3': 1, '4': 3, '5': 11, '6': '.pylons.pylons.ItemHistory', '10': 'history'},
  ],
};

/// Descriptor for `QueryGetItemHistoryResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetItemHistoryResponseDescriptor = $convert.base64Decode('ChtRdWVyeUdldEl0ZW1IaXN0b3J5UmVzcG9uc2USNAoHaGlzdG9yeRgBIAMoCzIaLnB5bG9ucy5weWxvbnMuSXRlbUhpc3RvcnlSB2hpc3Rvcnk=');
...
final $typed_data.Uint8List queryListItemByOwnerResponseDescriptor = $convert.base64Decode('ChxRdWVyeUxpc3RJdGVtQnlPd25lclJlc3BvbnNlEi8KBWl0ZW1zGAEgAygLMhMucHlsb25zLnB5bG9ucy5JdGVtQgTI3h8AUgVpdGVtcxJHCgpwYWdpbmF0aW9uGAIgASgLMicuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVzcG9uc2VSCnBhZ2luYXRpb246CIigHwDooB8A');
...
final $typed_data.Uint8List queryListExecutionsByItemRequestDescriptor = $convert.base64Decode('CiBRdWVyeUxpc3RFeGVjdXRpb25zQnlJdGVtUmVxdWVzdBIfCgtjb29rYm9va19pZBgBIAEoCVIKY29va2Jvb2tJZBIXCgdpdGVtX2lkGAIgASgJUgZpdGVtSWQSRgoKcGFnaW5hdGlvbhgDIAEoCzImLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlcXVlc3RSCnBhZ2luYXRpb246CIigHwDooB8A');
...
final $typed_data.Uint8List queryListExecutionsByRecipeRequestDescriptor = $convert.base64Decode('CiJRdWVyeUxpc3RFeGVjdXRpb25zQnlSZWNpcGVSZXF1ZXN0Eh8KC2Nvb2tib29rX2lkGAEgASgJUgpjb29rYm9va0lkEhsKCXJlY2lwZV9pZBgCIAEoCVIIcmVjaXBlSWQSRgoKcGFnaW5hdGlvbhgDIAEoCzImLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlcXVlc3RSCnBhZ2luYXRpb246CIigHwDooB8A');
