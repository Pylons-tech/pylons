...
const Execution$json = const {
  ...
  '2': const [
    ...
    const {'1': 'tx_time', '3': 13, '4': 1, '5': 3, '10': 'txTime'},
  ],
};

/// Descriptor for `Execution`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List executionDescriptor = $convert.base64Decode('');
