...
abstract class Repository {
  ...
  /// Input : [address] the address against which the invite link to be generated
  /// Output: [String] return the generated dynamic link else will return [Failure]
  Future<Either<Failure, String>> createDynamicLinkForNftShare({required String address, required String recipeId, required String cookbookId});
...
class RepositoryImp implements Repository {
  ...
  @override
  Future<Either<Failure, String>> createDynamicLinkForNftShare({required String address, required String recipeId, required String cookbookId}) async {
    try {
      return Right(await remoteDataStore.createDynamicLinkForNftShare(address: address, recipeId: recipeId, cookbookId: cookbookId));
    } on Exception catch (_) {
      return Left(FirebaseDynamicLinkFailure("dynamic_link_failure".tr()));
    }
  }
