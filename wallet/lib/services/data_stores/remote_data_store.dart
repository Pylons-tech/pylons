...
abstract class RemoteDataStore {
  ...
  Future<StripeGenerateRegistrationTokenResponse>
  ...
  /// else will through error
  Future<StripeUpdateAccountResponse> updateStripeAccount(
      {required StripeUpdateAccountRequest req});
  ...
  Future<StripeRegisterAccountResponse> registerAccount(
      {required StripeRegisterAccountRequest req});
  ...
  Future<int> getLikesCount(
      {required RecipeId recipeId, required CookbookId cookBookID});
  ...
  /// Output : [List][NftOwnershipHistory] will contain the list of NftOwnershipHistory data if success
  /// else will throw error
  Future<List<NftOwnershipHistory>>
  ...
  Future<pylons.Recipe> getRecipe(
      {required CookbookId cookBookId, required RecipeId recipeId});
  ...
  Future<List<pylons.Recipe>> getRecipesBasedOnCookBookId(
  ...
  Future<List<pylons.Trade>> getTradesBasedOnCreator(
  ...
  /// Output : [pylons.Trade] will be the the list of trades based on its [creator]
  Future<List<pylons.Cookbook>> getCookbooksByCreator(
      {required String address});
  ...
  Future<String> sendGoogleInAppPurchaseCoinsRequest(
  ...
  Future<String> sendAppleInAppPurchaseCoinsRequest(
      AppleInAppPurchaseModel googleInAppPurchaseModel);
  ...
  Future<bool> markNotificationAsRead(
      {required List<String> idsList, required String appCheckToken});
  ...
  /// Output: [String] return the generated dynamic link else will throw error
  Future<String> createDynamicLinkForRecipeNftShare(
      {required String address, required NFT nft});
  ...
  /// Output: [String] return the generated dynamic link else will throw error
  Future<String> createDynamicLinkForTradeNftShare(
      {required String address, required String tradeId});
  ...
  Future<Tuple2<cosmos_tx.Tx, cosmos_tx.TxResponse?>> getTx(
  ...
  Future<TransactionResponse> cancelTrade(
      {required TradeId tradeId, required Address address});

  Future<TransactionResponse> createTrade(
      {required pylons.MsgCreateTrade msgCreateTrade});
  ...
  /// Output: [String] return the generated dynamic link else will throw error
  Future<String> createDynamicLinkForRecipeEventShare(
      {required String address, required Events events});
...
class RemoteDataStoreImp implements RemoteDataStore {
  ...
  Future<void> updateLikeStatus({
    ...
    final uri =
        Uri.parse("$baseApiUrl/api/actions/likes/$cookBookID/$recipeId");
  ...
  @override
  Future<int> getLikesCount(
      {required RecipeId recipeId, required CookbookId cookBookID}) async {
  ...
  Future<void> countAView({
    ...
    final uri =
        Uri.parse("$baseApiUrl/api/actions/views/$cookBookID/$recipeId");
  ...
  Future<bool> ifLikedByMe({
    ...
    final uri = Uri.parse(
        "$baseApiUrl/api/actions/likes/$walletAddress/$cookBookID/$recipeId");
  ...
  @override
  Future<StripeGenerateRegistrationTokenResponse>
      generateStripeRegistrationToken({required String address}) async {
  ...
  Future<StripeUpdateAccountResponse> updateStripeAccount(
    ...
    if (response.statusCode == API_SUCCESS_CODE) {
      return StripeUpdateAccountResponse.fromJson(
          json.decode(utf8.decode(response.bodyBytes)) as Map<String, dynamic>);
    }
  ...
  Future<IBCTraceModel> getIBCHashTrace({required String ibcHash}) async {
    ...
    if (response.statusCode == API_SUCCESS_CODE) {
      return IBCTraceModel.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>, ibcHash);
    }
  ...
  @override
  Future<StripeRegisterAccountResponse> registerAccount(
      {required StripeRegisterAccountRequest req}) async {
    final baseEnv = getBaseEnv();
    final response = await httpClient
        .post(
            Uri.parse(
    ...
    if (response.statusCode == API_SUCCESS_CODE) {
      return StripeRegisterAccountResponse.from(
          json.decode(utf8.decode(response.bodyBytes)) as Map<String, dynamic>);
    }

    if (response.statusCode == API_ERROR_CODE &&
        response.body == 'account already setup\n') {
      throw const AccountAlreadyExistsFailure('Account Already exists');
    }
  ...
  Future<List<Balance>> getBalance(String walletAddress) async {
    ...
    for (final balance in response.balances) {
      if (balance.denom.contains("ibc")) {
        futureIBCHashList.add(
            getIBCHashTrace(ibcHash: balance.denom.replaceAll("ibc/", '')));
        continue;
      }
    ...
    for (final ibcHashResult in ibcHashResults) {
      final relatedBalance = response.balances.firstWhere(
          (element) => element.denom == "ibc/${ibcHashResult.ibcHash}");
      balances.add(Balance(
          denom: ibcHashResult.denomTrace.baseDenom.name,
          amount: Amount(Decimal.parse(relatedBalance.amount))));
    }
  ...
  Future<List<TransactionHistory>> getTransactionHistory(
    ...
    final transactionUri =
        '${baseEnv.baseApiUrl}/pylons/tx?address=%27$address%27';

    final transactionResponse = await httpClient
        .get(Uri.parse(transactionUri))
        .timeout(timeOutDuration);

    final transactionMap = jsonDecode(transactionResponse.body);

    if (transactionMap == null || transactionResponse.body.length == 2)
  ...
  Future<List<NotificationMessage>> getAllNotificationMessages(
    ...
    final uri = Uri.parse(
        "$baseApiUrl/api/notifications/getAllNotifications/$walletAddress/$limit/$offset");

    final notificationResponse =
        await httpClient.get(uri).timeout(timeOutDuration);
  ...
  Future<List<NftOwnershipHistory>> getNftOwnershipHistory(
    ...
    final uri =
        Uri.parse("$baseApiUrl/pylons/item_history/$cookBookId/$itemId");
  ...
  Future<List<NftOwnershipHistory>>
    ...
    final uri = Uri.parse(
        "$baseApiUrl/pylons/get_recipe_history/${cookBookId.toString()}/${recipeId.toString()}");
    ...
    historyMap[kHistory].map((e) {
      final nft = NftOwnershipHistory.fromCookBookAndRecipeJson(
  ...
  Future<String> updateRecipe({required UpdateRecipeModel updateRecipeModel}) {
    ...
    msgUpdateRecipe.coinInputs.first.coins.first.amount =
        updateRecipeModel.nftPrice;
    msgUpdateRecipe.coinInputs.first.coins.first.denom =
        updateRecipeModel.denom;
  ...
  @override
  Future<pylons.Recipe> getRecipe(
      {required CookbookId cookBookId, required RecipeId recipeId}) async {
    try {
  ...
  Future<Tuple2<cosmos_tx.Tx, cosmos_tx.TxResponse?>> getTx(
    ...
    final cosmos_tx.ServiceClient serviceClient =
        cosmos_tx.ServiceClient(sl.get<BaseEnv>().networkInfo.gRPCChannel);
  ...
  @override
  Future<pylons.Cookbook> getCookbookBasedOnId(
      {required String cookBookId}) async {
    try {
      const retry = RetryOptions();
  ...
  @override
  Future<bool> markNotificationAsRead(
      {required List<String> idsList, required String appCheckToken}) async {
    final baseApiUrl = getBaseEnv().baseMongoUrl;
  ...
  @override
  Future<List<pylons.Trade>> getTradesBasedOnCreator(
      {required Address creator}) async {
    final pylons.QueryClient queryClient = getQueryClient();
  ...
  Future<String> getAppCheckToken() async {
    final Future<String> token = Future<String>.value(generateRandomString(10));
  ...
  @override
  Future<String> sendGoogleInAppPurchaseCoinsRequest(
      GoogleInAppPurchaseModel googleInAppPurchaseModel) async {
  ...
  Future<String> sendAppleInAppPurchaseCoinsRequest(
    ...
    final msgAppleInAppPurchases = pylons.MsgAppleIap()
      ..mergeFromProto3Json(appleInAppPurchaseModel.toJson());
  ...
  @override
  Future<String> createDynamicLinkForUserInvite(
      {required String address}) async {
    final dynamicLinkParams = DynamicLinkParameters(
      link: Uri.parse("https://wallet.pylons.tech/invite/$address"),
      uriPrefix: "https://pylons.page.link/",
      androidParameters:
          const AndroidParameters(packageName: "tech.pylons.wallet"),
  ...
  @override
  Future<String> createDynamicLinkForRecipeNftShare(
      {required String address, required NFT nft}) async {
    ...
    final dynamicLinkParams = DynamicLinkParameters(
        link: Uri.parse(
            "$bigDipperBaseLink?recipe_id=${nft.recipeID}&cookbook_id=${nft.cookbookID}&address=$address"),
        uriPrefix: kDeepLink,
        ...
        socialMetaTagParameters: SocialMetaTagParameters(
          ...
          description:
              '${nft.description}  Price:${nft.price == "0" ? LocaleKeys.free.tr() : updateText}',
        ));
  ...
  Future<String> createDynamicLinkForItemNftShare({
    ...
    final dynamicLinkParams = DynamicLinkParameters(
      link: Uri.parse(
          "$bigDipperBaseLink?item_id=$itemId&cookbook_id=$cookbookId&address=$address"),
      uriPrefix: kDeepLink,
      androidParameters: AndroidParameters(
          packageName: packageName,
          fallbackUrl: Uri.parse(
  ...
  @override
  Future<String> createDynamicLinkForTradeNftShare(
      {required String address, required String tradeId}) async {
    final dynamicLinkParams = DynamicLinkParameters(
      ...
      androidParameters: AndroidParameters(
          packageName: packageName,
          fallbackUrl: Uri.parse(
              "$bigDipperBaseLink?trade_id=$tradeId&address=$address")),
      iosParameters: const IOSParameters(bundleId: bundleId),
    );
  ...
  Future<bool> saveUserFeedback(
      ...
      required String subject,
      required String feedback}) {
    return firebaseHelper.saveUserFeedback(
        walletAddress: walletAddress, subject: subject, feedback: feedback);
  }
  ...
  @override
  Future<TransactionResponse> cancelTrade(
      {required TradeId tradeId, required Address address}) async {
  ...
  @override
  Future<TransactionResponse> createTrade(
      {required pylons.MsgCreateTrade msgCreateTrade}) async {
  ...
  @override
  Future<String> createDynamicLinkForRecipeEventShare(
      {required String address, required Events events}) async {
    ...
    final dynamicLinkParams = DynamicLinkParameters(
        link: Uri.parse(
            "$bigDipperBaseLink?recipe_id=${events.recipeID}&cookbook_id=${events.cookbookID}&address=$address"),
        uriPrefix: kDeepLink,
        androidParameters: AndroidParameters(
          packageName: packageName,
          fallbackUrl: Uri.parse(
        ...
        socialMetaTagParameters: SocialMetaTagParameters(
          ...
          description:
              '${events.description}  Price:${events.price == "0" ? LocaleKeys.free.tr() : updateText}',
        ));
