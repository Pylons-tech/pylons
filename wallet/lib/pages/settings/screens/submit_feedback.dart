...
class SubmitFeedback {
  ...
  Future<void> show() async {
    await showDialog<String>(context: context, barrierDismissible: true, builder: (BuildContext context) => const _SubmitFeedbackDialog());
  }
}
...
class _SubmitFeedbackDialogState extends State<_SubmitFeedbackDialog> {
  ...
  Future<void> onSubmitButtonPressed() async {
    ...
    await repository.saveUserFeedback(walletAddress: walletAddress, subject: subjectController.text, feedback: descController.text);
