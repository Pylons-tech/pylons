...
abstract class HTMLBuilder {
  ...
  static String build({
    ...
    if (rotationPerSecond != null) {
      html.write(' rotation-per-second="${htmlEscape.convert(rotationPerSecond)}"');
    }
    // interaction-policy
    ...
    if (environmentImage != null) {
      html.write(' environment-image="${htmlEscape.convert(environmentImage)}"');
    }
    // exposure
    if (exposure != null) {
      if (exposure < 0) {
    ...
    html.write(' style="');
    // CSS Styles
    html.write('background-color: rgba(${backgroundColor.red}, ${backgroundColor.green}, ${backgroundColor.blue}, ${backgroundColor.alpha}); ');
    // Loading CSS
    // --poster-color
    if (posterColor != null) {
      html.write('poster-color: rgba(${posterColor.red}, ${posterColor.green}, ${posterColor.blue}, ${posterColor.alpha}); ');
    }
