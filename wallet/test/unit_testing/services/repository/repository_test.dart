...
void main() {
  ...
  test('should get account link and account on  getAccountLinkBasedOnUpdateToken', () async {
    final response = await mockRepository.getAccountLinkBasedOnUpdateToken(MOCK_STRIPE_UPDATE_ACCOUNT_REQUEST);
  ...
  test('should get account link and account on  getLoginLinkBasedOnAddress', () async {
    final response = await mockRepository.getLoginLinkBasedOnAddress(MOCK_STRIPE_LOGIN_BASED_ADDRESS_REQUEST);
  ...
  test('should get whether user getting do i accept policy or not', () {
    ...
    expect(true, response.isRight());
    expect(true, response.getOrElse(() => false));
  });

  test('should system save that user accepted policies or not', () async {
    final response = await mockRepository.saveUserAcceptPolicies();
