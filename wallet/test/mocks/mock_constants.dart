...
NFT MOCK_DISABLED_NFT_IMAGE = NFT(
  name: "This is my Image NFT",
  height: "2400",
  description: "Please Buy my Image NFT",
  width: "1080",
...
const MOCK_NAME = "Ahmad";
const MOCK_ACCOUNT_ID = "account1";
const MOCK_PUBLIC_ADDRESS = "publicAddress123";
const MOCK_CHAIN_ID = "chain_id_1";
const MOCK_PYLONS_BANNER = "pylons_banner_file_uri";
const MOCK_PYLONS_AVATAR = "pylons_avatar_file_uri";
const MOCK_TABS = ["Collection", "Wallet"];
