    ...
    render() {
        ...
        return(
            <Row className="header text-nowrap d-none d-sm-flex">                
                ...
                <Col sm={3} md={2} lg={2}><i className="fas fa-portrait fa-lg"></i>  <span className="d-none d-xl-inline"><T>blocks.proposer</T></span></Col>
                {homepage ? <Col sm={1} md={2}><span className="d-xl-none"><i className="fas fa-sync"></i></span><span className="ml-n5 d-none d-xl-inline"><i className="fas fa-sync"></i> <span ><T>blocks.numOfTxs</T></span></span></Col> : <Col sm={1} md={2}><i className="fas fa-sync"></i> <span className="d-none d-xl-inline"><T>blocks.numOfTxs</T></span></Col>}
