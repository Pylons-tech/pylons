<template>
	<v-navigation-drawer v-model="showDrawer" app class="app-drawer" v-model:mini-variant="mini" mini-variant-width="64" :width="drawerWidth">
		...
		<AppSwitcher />
		<VuePerfectScrollbar class="app-drawer__scrollbar">
			<div class="app-drawer__inner">
				<NavList :items="computeMenu" :mini="mini" />
			</div>
		</VuePerfectScrollbar>
		<template #append>
