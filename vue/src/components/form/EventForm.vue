		...
		<v-card-text style="max-height: 450px; overflow: auto">
			<v-form ref="form" v-model="valid" lazy-validation>
				<v-container>
					<v-row>
						<v-col :cols="12">
							<v-text-field v-model="formModel.title" :label="form.title.label" :placeholder="form.title.placeholder" :rules="form.title.rules" />
						</v-col>
						<v-col :cols="12">
							<v-autocomplete v-model="formModel.color" :items="colors" :label="form.color.label" :placeholder="form.color.placeholder">
								<template #item="data">
									<v-list-item-avatar>
						...
						<v-col :cols="6">
							<v-menu
								...
								offset-y
								max-width="290px"
								v-model:return-value="formModel.startDate"
							>
						...
						<v-col :cols="6">
							<v-menu
								...
								offset-y
								max-width="290px"
								v-model:return-value="formModel.startTime"
							>
								<template #activator="{ on }">
									<v-text-field
						...
						<v-col :cols="6">
							<v-menu
								...
								offset-y
								min-width="290px"
								v-model:return-value="formModel.endDate"
							>
								<template #activator="{ on }">
									<v-text-field
						...
						<v-col :cols="6">
							<v-menu
								...
								offset-y
								max-width="290px"
								v-model:return-value="formModel.endTime"
							>
								<template #activator="{ on }">
									<v-text-field
						...
						<v-col :cols="12">
							<v-textarea v-model="formModel.remark" outlined :rows="2" :label="form.remark.lable" :placeholder="form.remark.placeholder" />
						</v-col>
						<v-spacer />
					</v-row>
				</v-container>
