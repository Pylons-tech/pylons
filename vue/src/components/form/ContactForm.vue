	...
	<v-card tile>
		...
		<v-card-text>
			<v-form ref="form" v-model="valid">
				...
				/>
				<v-text-field v-model="formModel.city" outlined :label="form.city.label" :placeholder="form.city.placeholder" required :rules="form.city.rules" />
				<v-text-field v-model="formModel.state" outlined :label="form.state.label" :placeholder="form.state.placeholder" required :rules="form.state.rules" />
				<v-text-field
