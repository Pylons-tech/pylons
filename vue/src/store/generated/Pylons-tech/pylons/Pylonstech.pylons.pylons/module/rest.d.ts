...
export declare type PylonsMsgBurnDebtTokenResponse = object;
...
export interface PylonsPaymentInfo {
    purchaseID?: string;
...
export interface PylonsQueryAllPaymentInfoResponse {
    PaymentInfo?: PylonsPaymentInfo[];
    /**
...
export interface PylonsQueryAllRedeemInfoResponse {
    RedeemInfo?: PylonsRedeemInfo[];
    /**
     * PageResponse is to be embedded in gRPC response messages where the
     * corresponding request message has used PageRequest.
     *
...
export interface PylonsQueryGetPaymentInfoResponse {
    PaymentInfo?: PylonsPaymentInfo;
}
export interface PylonsQueryGetRecipeResponse {
    Recipe?: PylonsRecipe;
}
export interface PylonsQueryGetRedeemInfoResponse {
    RedeemInfo?: PylonsRedeemInfo;
}
...
export interface PylonsRedeemInfo {
    ID?: string;
    processorName?: string;
    address?: string;
    amount?: string;
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    ...
    queryFight: (query?: {
        ID?: string;
    }, params?: RequestParams) => Promise<HttpResponse<PylonsQueryFightResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryPaymentInfo: (purchaseID: string, params?: RequestParams) => Promise<HttpResponse<PylonsQueryGetPaymentInfoResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryPaymentInfoAll: (query?: {
        "pagination.key"?: string;
        "pagination.offset"?: string;
        "pagination.limit"?: string;
        "pagination.countTotal"?: boolean;
        "pagination.reverse"?: boolean;
    }, params?: RequestParams) => Promise<HttpResponse<PylonsQueryAllPaymentInfoResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryRedeemInfo: (ID: string, params?: RequestParams) => Promise<HttpResponse<PylonsQueryGetRedeemInfoResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryRedeemInfoAll: (query?: {
        "pagination.key"?: string;
        "pagination.offset"?: string;
        "pagination.limit"?: string;
        "pagination.countTotal"?: boolean;
        "pagination.reverse"?: boolean;
    }, params?: RequestParams) => Promise<HttpResponse<PylonsQueryAllRedeemInfoResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
