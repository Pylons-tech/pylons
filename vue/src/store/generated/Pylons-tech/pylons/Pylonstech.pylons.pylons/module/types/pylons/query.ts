...
export const QueryListTradesByCreatorRequest = {
  ...
  decode(
    ...
    const message = {
      ...baseQueryListTradesByCreatorRequest,
    } as QueryListTradesByCreatorRequest;
  ...
  fromPartial(
    object: DeepPartial<QueryListTradesByCreatorRequest>
  ): QueryListTradesByCreatorRequest {
    const message = {
      ...baseQueryListTradesByCreatorRequest,
    } as QueryListTradesByCreatorRequest;
...
export const QueryListTradesByCreatorResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryListTradesByCreatorResponse,
    } as QueryListTradesByCreatorResponse;
    message.Trades = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<QueryListTradesByCreatorResponse>
  ): QueryListTradesByCreatorResponse {
    const message = {
      ...baseQueryListTradesByCreatorResponse,
    } as QueryListTradesByCreatorResponse;
...
const baseQueryGetRedeemInfoRequest: object = { ID: "" };
...
export const QueryGetRedeemInfoRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetRedeemInfoRequest,
    } as QueryGetRedeemInfoRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetRedeemInfoRequest>
  ): QueryGetRedeemInfoRequest {
    const message = {
      ...baseQueryGetRedeemInfoRequest,
    } as QueryGetRedeemInfoRequest;
...
const baseQueryGetRedeemInfoResponse: object = {};
...
export const QueryGetRedeemInfoResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetRedeemInfoResponse,
    } as QueryGetRedeemInfoResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryGetRedeemInfoResponse {
    ...
    if (object.RedeemInfo !== undefined && object.RedeemInfo !== null) {
      message.RedeemInfo = RedeemInfo.fromJSON(object.RedeemInfo);
    } else {
      message.RedeemInfo = undefined;
    }
    return message;
  },
  ...
  toJSON(message: QueryGetRedeemInfoResponse): unknown {
    const obj: any = {};
    message.RedeemInfo !== undefined &&
      (obj.RedeemInfo = message.RedeemInfo
        ? RedeemInfo.toJSON(message.RedeemInfo)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryGetRedeemInfoResponse>
  ): QueryGetRedeemInfoResponse {
    const message = {
      ...baseQueryGetRedeemInfoResponse,
    } as QueryGetRedeemInfoResponse;
    if (object.RedeemInfo !== undefined && object.RedeemInfo !== null) {
      message.RedeemInfo = RedeemInfo.fromPartial(object.RedeemInfo);
    } else {
      message.RedeemInfo = undefined;
    }
    return message;
...
const baseQueryAllRedeemInfoRequest: object = {};
...
export const QueryAllRedeemInfoRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllRedeemInfoRequest,
    } as QueryAllRedeemInfoRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryAllRedeemInfoRequest>
  ): QueryAllRedeemInfoRequest {
    const message = {
      ...baseQueryAllRedeemInfoRequest,
    } as QueryAllRedeemInfoRequest;
...
const baseQueryAllRedeemInfoResponse: object = {};
...
export const QueryAllRedeemInfoResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllRedeemInfoResponse,
    } as QueryAllRedeemInfoResponse;
    message.RedeemInfo = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromJSON(object: any): QueryAllRedeemInfoResponse {
    ...
    message.RedeemInfo = [];
    if (object.RedeemInfo !== undefined && object.RedeemInfo !== null) {
      for (const e of object.RedeemInfo) {
        message.RedeemInfo.push(RedeemInfo.fromJSON(e));
      }
    }
    if (object.pagination !== undefined && object.pagination !== null) {
      message.pagination = PageResponse.fromJSON(object.pagination);
  ...
  toJSON(message: QueryAllRedeemInfoResponse): unknown {
    ...
    if (message.RedeemInfo) {
      obj.RedeemInfo = message.RedeemInfo.map((e) =>
        e ? RedeemInfo.toJSON(e) : undefined
      );
    } else {
      obj.RedeemInfo = [];
    }
  ...
  fromPartial(
    object: DeepPartial<QueryAllRedeemInfoResponse>
  ): QueryAllRedeemInfoResponse {
    const message = {
      ...baseQueryAllRedeemInfoResponse,
    } as QueryAllRedeemInfoResponse;
    ...
    if (object.RedeemInfo !== undefined && object.RedeemInfo !== null) {
      for (const e of object.RedeemInfo) {
        message.RedeemInfo.push(RedeemInfo.fromPartial(e));
      }
    }
    if (object.pagination !== undefined && object.pagination !== null) {
      message.pagination = PageResponse.fromPartial(object.pagination);
...
const baseQueryGetPaymentInfoRequest: object = { purchaseID: "" };
...
export const QueryGetPaymentInfoRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetPaymentInfoRequest,
    } as QueryGetPaymentInfoRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetPaymentInfoRequest>
  ): QueryGetPaymentInfoRequest {
    const message = {
      ...baseQueryGetPaymentInfoRequest,
    } as QueryGetPaymentInfoRequest;
...
const baseQueryGetPaymentInfoResponse: object = {};
...
export const QueryGetPaymentInfoResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetPaymentInfoResponse,
    } as QueryGetPaymentInfoResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryGetPaymentInfoResponse {
    ...
    if (object.PaymentInfo !== undefined && object.PaymentInfo !== null) {
      message.PaymentInfo = PaymentInfo.fromJSON(object.PaymentInfo);
    } else {
  ...
  toJSON(message: QueryGetPaymentInfoResponse): unknown {
    ...
    message.PaymentInfo !== undefined &&
      (obj.PaymentInfo = message.PaymentInfo
        ? PaymentInfo.toJSON(message.PaymentInfo)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryGetPaymentInfoResponse>
  ): QueryGetPaymentInfoResponse {
    const message = {
      ...baseQueryGetPaymentInfoResponse,
    } as QueryGetPaymentInfoResponse;
    if (object.PaymentInfo !== undefined && object.PaymentInfo !== null) {
      message.PaymentInfo = PaymentInfo.fromPartial(object.PaymentInfo);
    } else {
      message.PaymentInfo = undefined;
    }
    return message;
...
const baseQueryAllPaymentInfoRequest: object = {};
...
export const QueryAllPaymentInfoRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllPaymentInfoRequest,
    } as QueryAllPaymentInfoRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryAllPaymentInfoRequest>
  ): QueryAllPaymentInfoRequest {
    const message = {
      ...baseQueryAllPaymentInfoRequest,
    } as QueryAllPaymentInfoRequest;
...
const baseQueryAllPaymentInfoResponse: object = {};
...
export const QueryAllPaymentInfoResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllPaymentInfoResponse,
    } as QueryAllPaymentInfoResponse;
    message.PaymentInfo = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromJSON(object: any): QueryAllPaymentInfoResponse {
    ...
    message.PaymentInfo = [];
    if (object.PaymentInfo !== undefined && object.PaymentInfo !== null) {
      for (const e of object.PaymentInfo) {
        message.PaymentInfo.push(PaymentInfo.fromJSON(e));
      }
    }
    if (object.pagination !== undefined && object.pagination !== null) {
      message.pagination = PageResponse.fromJSON(object.pagination);
  ...
  toJSON(message: QueryAllPaymentInfoResponse): unknown {
    ...
    if (message.PaymentInfo) {
      obj.PaymentInfo = message.PaymentInfo.map((e) =>
        e ? PaymentInfo.toJSON(e) : undefined
      );
    } else {
      obj.PaymentInfo = [];
    }
  ...
  fromPartial(
    object: DeepPartial<QueryAllPaymentInfoResponse>
  ): QueryAllPaymentInfoResponse {
    const message = {
      ...baseQueryAllPaymentInfoResponse,
    } as QueryAllPaymentInfoResponse;
    ...
    if (object.PaymentInfo !== undefined && object.PaymentInfo !== null) {
      for (const e of object.PaymentInfo) {
        message.PaymentInfo.push(PaymentInfo.fromPartial(e));
      }
    }
    if (object.pagination !== undefined && object.pagination !== null) {
      message.pagination = PageResponse.fromPartial(object.pagination);
...
export const QueryGetUsernameByAddressRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetUsernameByAddressRequest,
    } as QueryGetUsernameByAddressRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetUsernameByAddressRequest>
  ): QueryGetUsernameByAddressRequest {
    const message = {
      ...baseQueryGetUsernameByAddressRequest,
    } as QueryGetUsernameByAddressRequest;
...
export const QueryGetAddressByUsernameRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetAddressByUsernameRequest,
    } as QueryGetAddressByUsernameRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetAddressByUsernameRequest>
  ): QueryGetAddressByUsernameRequest {
    const message = {
      ...baseQueryGetAddressByUsernameRequest,
    } as QueryGetAddressByUsernameRequest;
...
export const QueryGetUsernameByAddressResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetUsernameByAddressResponse,
    } as QueryGetUsernameByAddressResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetUsernameByAddressResponse>
  ): QueryGetUsernameByAddressResponse {
    const message = {
      ...baseQueryGetUsernameByAddressResponse,
    } as QueryGetUsernameByAddressResponse;
...
export const QueryGetAddressByUsernameResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetAddressByUsernameResponse,
    } as QueryGetAddressByUsernameResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: QueryGetAddressByUsernameResponse): unknown {
    ...
    message.address !== undefined &&
      (obj.address = message.address
        ? AccountAddr.toJSON(message.address)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryGetAddressByUsernameResponse>
  ): QueryGetAddressByUsernameResponse {
    const message = {
      ...baseQueryGetAddressByUsernameResponse,
    } as QueryGetAddressByUsernameResponse;
...
export const QueryGetTradeResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryGetTradeResponse>
...
export const QueryListItemByOwnerRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryListItemByOwnerRequest,
    } as QueryListItemByOwnerRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryListItemByOwnerRequest>
  ): QueryListItemByOwnerRequest {
    const message = {
      ...baseQueryListItemByOwnerRequest,
    } as QueryListItemByOwnerRequest;
...
export const QueryListItemByOwnerResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryListItemByOwnerResponse,
    } as QueryListItemByOwnerResponse;
    message.Items = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<QueryListItemByOwnerResponse>
  ): QueryListItemByOwnerResponse {
    const message = {
      ...baseQueryListItemByOwnerResponse,
    } as QueryListItemByOwnerResponse;
...
const baseQueryGetGoogleInAppPurchaseOrderRequest: object = {
  PurchaseToken: "",
};
...
export const QueryGetGoogleInAppPurchaseOrderRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetGoogleInAppPurchaseOrderRequest,
    } as QueryGetGoogleInAppPurchaseOrderRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetGoogleInAppPurchaseOrderRequest>
  ): QueryGetGoogleInAppPurchaseOrderRequest {
    const message = {
      ...baseQueryGetGoogleInAppPurchaseOrderRequest,
    } as QueryGetGoogleInAppPurchaseOrderRequest;
...
export const QueryGetGoogleInAppPurchaseOrderResponse = {
  encode(
    ...
    if (message.Order !== undefined) {
      GoogleInAppPurchaseOrder.encode(
        message.Order,
        writer.uint32(10).fork()
      ).ldelim();
    }
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetGoogleInAppPurchaseOrderResponse,
    } as QueryGetGoogleInAppPurchaseOrderResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.Order = GoogleInAppPurchaseOrder.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  toJSON(message: QueryGetGoogleInAppPurchaseOrderResponse): unknown {
    ...
    message.Order !== undefined &&
      (obj.Order = message.Order
        ? GoogleInAppPurchaseOrder.toJSON(message.Order)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryGetGoogleInAppPurchaseOrderResponse>
  ): QueryGetGoogleInAppPurchaseOrderResponse {
    const message = {
      ...baseQueryGetGoogleInAppPurchaseOrderResponse,
    } as QueryGetGoogleInAppPurchaseOrderResponse;
...
const baseQueryListExecutionsByItemRequest: object = {
  CookbookID: "",
  ItemID: "",
};
...
export const QueryListExecutionsByItemRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryListExecutionsByItemRequest,
    } as QueryListExecutionsByItemRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryListExecutionsByItemRequest>
  ): QueryListExecutionsByItemRequest {
    const message = {
      ...baseQueryListExecutionsByItemRequest,
    } as QueryListExecutionsByItemRequest;
...
export const QueryListExecutionsByItemResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryListExecutionsByItemResponse,
    } as QueryListExecutionsByItemResponse;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.CompletedExecutions.push(
            Execution.decode(reader, reader.uint32())
          );
          break;
        case 2:
          message.PendingExecutions.push(
            Execution.decode(reader, reader.uint32())
          );
          break;
        case 3:
  ...
  fromJSON(object: any): QueryListExecutionsByItemResponse {
    ...
    message.PendingExecutions = [];
    if (
      object.CompletedExecutions !== undefined &&
      object.CompletedExecutions !== null
    ) {
    ...
    if (
      object.PendingExecutions !== undefined &&
      object.PendingExecutions !== null
    ) {
  ...
  toJSON(message: QueryListExecutionsByItemResponse): unknown {
    ...
    if (message.CompletedExecutions) {
      obj.CompletedExecutions = message.CompletedExecutions.map((e) =>
    ...
    if (message.PendingExecutions) {
      obj.PendingExecutions = message.PendingExecutions.map((e) =>
        e ? Execution.toJSON(e) : undefined
      );
    } else {
  ...
  fromPartial(
    object: DeepPartial<QueryListExecutionsByItemResponse>
  ): QueryListExecutionsByItemResponse {
    const message = {
      ...baseQueryListExecutionsByItemResponse,
    } as QueryListExecutionsByItemResponse;
...
const baseQueryListExecutionsByRecipeRequest: object = {
  CookbookID: "",
  RecipeID: "",
};
...
export const QueryListExecutionsByRecipeRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryListExecutionsByRecipeRequest,
    } as QueryListExecutionsByRecipeRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryListExecutionsByRecipeRequest>
  ): QueryListExecutionsByRecipeRequest {
    const message = {
      ...baseQueryListExecutionsByRecipeRequest,
    } as QueryListExecutionsByRecipeRequest;
...
export const QueryListExecutionsByRecipeResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryListExecutionsByRecipeResponse,
    } as QueryListExecutionsByRecipeResponse;
    message.CompletedExecutions = [];
    message.PendingExecutions = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
  ...
  fromPartial(
    object: DeepPartial<QueryListExecutionsByRecipeResponse>
  ): QueryListExecutionsByRecipeResponse {
    const message = {
      ...baseQueryListExecutionsByRecipeResponse,
    } as QueryListExecutionsByRecipeResponse;
...
export const QueryGetExecutionRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetExecutionRequest,
    } as QueryGetExecutionRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetExecutionRequest>
  ): QueryGetExecutionRequest {
    const message = {
      ...baseQueryGetExecutionRequest,
    } as QueryGetExecutionRequest;
...
export const QueryGetExecutionResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetExecutionResponse,
    } as QueryGetExecutionResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetExecutionResponse>
  ): QueryGetExecutionResponse {
    const message = {
      ...baseQueryGetExecutionResponse,
    } as QueryGetExecutionResponse;
...
export const QueryListRecipesByCookbookRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryListRecipesByCookbookRequest,
    } as QueryListRecipesByCookbookRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryListRecipesByCookbookRequest>
  ): QueryListRecipesByCookbookRequest {
    const message = {
      ...baseQueryListRecipesByCookbookRequest,
    } as QueryListRecipesByCookbookRequest;
...
export const QueryListRecipesByCookbookResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryListRecipesByCookbookResponse,
    } as QueryListRecipesByCookbookResponse;
    message.Recipes = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<QueryListRecipesByCookbookResponse>
  ): QueryListRecipesByCookbookResponse {
    const message = {
      ...baseQueryListRecipesByCookbookResponse,
    } as QueryListRecipesByCookbookResponse;
...
export const QueryGetRecipeRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryGetRecipeRequest>
...
export const QueryGetRecipeResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryGetRecipeResponse>
...
export const QueryListCookbooksByCreatorRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryListCookbooksByCreatorRequest,
    } as QueryListCookbooksByCreatorRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryListCookbooksByCreatorRequest>
  ): QueryListCookbooksByCreatorRequest {
    const message = {
      ...baseQueryListCookbooksByCreatorRequest,
    } as QueryListCookbooksByCreatorRequest;
...
export const QueryListCookbooksByCreatorResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryListCookbooksByCreatorResponse,
    } as QueryListCookbooksByCreatorResponse;
    message.Cookbooks = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  toJSON(message: QueryListCookbooksByCreatorResponse): unknown {
    ...
    if (message.Cookbooks) {
      obj.Cookbooks = message.Cookbooks.map((e) =>
        e ? Cookbook.toJSON(e) : undefined
      );
    } else {
      obj.Cookbooks = [];
    }
  ...
  fromPartial(
    object: DeepPartial<QueryListCookbooksByCreatorResponse>
  ): QueryListCookbooksByCreatorResponse {
    const message = {
      ...baseQueryListCookbooksByCreatorResponse,
    } as QueryListCookbooksByCreatorResponse;
...
export const QueryGetCookbookRequest = {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetCookbookRequest {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetCookbookRequest,
    } as QueryGetCookbookRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetCookbookRequest>
...
export const QueryGetCookbookResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetCookbookResponse,
    } as QueryGetCookbookResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: QueryGetCookbookResponse): unknown {
    const obj: any = {};
    message.Cookbook !== undefined &&
      (obj.Cookbook = message.Cookbook
        ? Cookbook.toJSON(message.Cookbook)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryGetCookbookResponse>
  ): QueryGetCookbookResponse {
    const message = {
      ...baseQueryGetCookbookResponse,
    } as QueryGetCookbookResponse;
...
export interface Query {
  ...
  ): Promise<QueryGetRedeemInfoResponse>;
  /** Queries a list of redeemInfo items. */
  RedeemInfoAll(
    request: QueryAllRedeemInfoRequest
  ): Promise<QueryAllRedeemInfoResponse>;
  /** Queries a paymentInfo by index. */
  PaymentInfo(
    request: QueryGetPaymentInfoRequest
  ): Promise<QueryGetPaymentInfoResponse>;
  /** Queries a list of paymentInfo items. */
  PaymentInfoAll(
    request: QueryAllPaymentInfoRequest
  ): Promise<QueryAllPaymentInfoResponse>;
  /** Queries a list of getAccountByAddress items. */
  UsernameByAddress(
    request: QueryGetUsernameByAddressRequest
  ): Promise<QueryGetUsernameByAddressResponse>;
  /** Queries a username by account. */
  AddressByUsername(
    request: QueryGetAddressByUsernameRequest
  ): Promise<QueryGetAddressByUsernameResponse>;
  ...
  ListItemByOwner(
    request: QueryListItemByOwnerRequest
  ): Promise<QueryListItemByOwnerResponse>;
  /** Queries a googleIAPOrder by PurchaseToken. */
  GoogleInAppPurchaseOrder(
    request: QueryGetGoogleInAppPurchaseOrderRequest
  ): Promise<QueryGetGoogleInAppPurchaseOrderResponse>;
  /** Queries a list of listExecutionsByItem items. */
  ListExecutionsByItem(
    request: QueryListExecutionsByItemRequest
  ): Promise<QueryListExecutionsByItemResponse>;
  /** Queries a list of listExecutionsByRecipe items. */
  ListExecutionsByRecipe(
    request: QueryListExecutionsByRecipeRequest
  ): Promise<QueryListExecutionsByRecipeResponse>;
  /** Queries a execution by id. */
  Execution(
    request: QueryGetExecutionRequest
  ): Promise<QueryGetExecutionResponse>;
  /** Queries a list of listRecipesByCookbook items. */
  ListRecipesByCookbook(
    request: QueryListRecipesByCookbookRequest
  ): Promise<QueryListRecipesByCookbookResponse>;
  ...
  ListCookbooksByCreator(
    request: QueryListCookbooksByCreatorRequest
  ): Promise<QueryListCookbooksByCreatorResponse>;
...
export class QueryClientImpl implements Query {
  ...
  RedeemInfo(
    ...
    return promise.then((data) =>
      QueryGetRedeemInfoResponse.decode(new Reader(data))
    );
  }
  ...
  RedeemInfoAll(
    ...
    const data = QueryAllRedeemInfoRequest.encode(request).finish();
    const promise = this.rpc.request(
      "Pylonstech.pylons.pylons.Query",
      "RedeemInfoAll",
      data
    ...
    return promise.then((data) =>
      QueryAllRedeemInfoResponse.decode(new Reader(data))
    );
  }
  ...
  PaymentInfo(
    ...
    const data = QueryGetPaymentInfoRequest.encode(request).finish();
    const promise = this.rpc.request(
      "Pylonstech.pylons.pylons.Query",
      "PaymentInfo",
      data
    ...
    return promise.then((data) =>
      QueryGetPaymentInfoResponse.decode(new Reader(data))
    );
  }
  ...
  PaymentInfoAll(
    ...
    const data = QueryAllPaymentInfoRequest.encode(request).finish();
    const promise = this.rpc.request(
      "Pylonstech.pylons.pylons.Query",
      "PaymentInfoAll",
      data
    ...
    return promise.then((data) =>
      QueryAllPaymentInfoResponse.decode(new Reader(data))
    );
  }
  ...
  UsernameByAddress(
    ...
    return promise.then((data) =>
      QueryGetUsernameByAddressResponse.decode(new Reader(data))
    );
  }
  ...
  AddressByUsername(
    ...
    return promise.then((data) =>
      QueryGetAddressByUsernameResponse.decode(new Reader(data))
    );
  }
  ...
  Trade(request: QueryGetTradeRequest): Promise<QueryGetTradeResponse> {
    ...
    return promise.then((data) =>
      QueryGetTradeResponse.decode(new Reader(data))
    );
  }
  ...
  ListItemByOwner(
    ...
    return promise.then((data) =>
      QueryListItemByOwnerResponse.decode(new Reader(data))
    );
  }
  ...
  GoogleInAppPurchaseOrder(
    ...
    const data = QueryGetGoogleInAppPurchaseOrderRequest.encode(
      request
    ).finish();
    const promise = this.rpc.request(
      "Pylonstech.pylons.pylons.Query",
    ...
    return promise.then((data) =>
      QueryGetGoogleInAppPurchaseOrderResponse.decode(new Reader(data))
    );
  }
  ...
  ListExecutionsByItem(
    ...
    return promise.then((data) =>
      QueryListExecutionsByItemResponse.decode(new Reader(data))
    );
  }
  ...
  ListExecutionsByRecipe(
    ...
    return promise.then((data) =>
      QueryListExecutionsByRecipeResponse.decode(new Reader(data))
    );
  }
  ...
  Execution(
    ...
    return promise.then((data) =>
      QueryGetExecutionResponse.decode(new Reader(data))
    );
  }
  ...
  ListRecipesByCookbook(
    ...
    return promise.then((data) =>
      QueryListRecipesByCookbookResponse.decode(new Reader(data))
    );
  }
  ...
  Recipe(request: QueryGetRecipeRequest): Promise<QueryGetRecipeResponse> {
    ...
    return promise.then((data) =>
      QueryGetRecipeResponse.decode(new Reader(data))
    );
  }
  ...
  ListCookbooksByCreator(
    ...
    return promise.then((data) =>
      QueryListCookbooksByCreatorResponse.decode(new Reader(data))
    );
  }

  Cookbook(
    request: QueryGetCookbookRequest
  ): Promise<QueryGetCookbookResponse> {
    ...
    return promise.then((data) =>
      QueryGetCookbookResponse.decode(new Reader(data))
    );
  }
}
