...
export const GenesisState = {
  ...
  decode(input: Reader | Uint8Array, length?: number): GenesisState {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 16:
          message.redeemInfoList.push(
            RedeemInfo.decode(reader, reader.uint32())
          );
          break;
        case 15:
          message.paymentInfoList.push(
        ...
        case 10:
          ...
          break;
        case 8:
          message.googleInAppPurchaseOrderList.push(
            GoogleInAppPurchaseOrder.decode(reader, reader.uint32())
          );
          break;
        case 9:
        ...
        case 6:
          ...
          break;
        case 5:
          message.pendingExecutionList.push(
  ...
  fromJSON(object: any): GenesisState {
    ...
    message.recipeList = [];
    message.cookbookList = [];
    if (object.redeemInfoList !== undefined && object.redeemInfoList !== null) {
      for (const e of object.redeemInfoList) {
        message.redeemInfoList.push(RedeemInfo.fromJSON(e));
      }
    }
    if (
      object.paymentInfoList !== undefined &&
      object.paymentInfoList !== null
    ) {
      for (const e of object.paymentInfoList) {
        message.paymentInfoList.push(PaymentInfo.fromJSON(e));
      }
    }
    ...
    if (
      object.googleInAppPurchaseOrderList !== undefined &&
      object.googleInAppPurchaseOrderList !== null
    ) {
      for (const e of object.googleInAppPurchaseOrderList) {
        message.googleInAppPurchaseOrderList.push(
          GoogleInAppPurchaseOrder.fromJSON(e)
        );
      }
    }
    if (
      object.googleIAPOrderCount !== undefined &&
      object.googleIAPOrderCount !== null
    ) {
    ...
    if (
      object.pendingExecutionList !== undefined &&
      object.pendingExecutionList !== null
    ) {
    ...
    if (
      object.pendingExecutionCount !== undefined &&
      object.pendingExecutionCount !== null
    ) {
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.redeemInfoList) {
      obj.redeemInfoList = message.redeemInfoList.map((e) =>
    ...
    if (message.paymentInfoList) {
      obj.paymentInfoList = message.paymentInfoList.map((e) =>
    ...
    if (message.accountList) {
      obj.accountList = message.accountList.map((e) =>
        e ? UserMap.toJSON(e) : undefined
      );
    } else {
      obj.accountList = [];
    }
    if (message.tradeList) {
      obj.tradeList = message.tradeList.map((e) =>
        e ? Trade.toJSON(e) : undefined
      );
    } else {
      obj.tradeList = [];
    }
    message.tradeCount !== undefined && (obj.tradeCount = message.tradeCount);
    message.entityCount !== undefined &&
      (obj.entityCount = message.entityCount);
    message.params !== undefined &&
      (obj.params = message.params ? Params.toJSON(message.params) : undefined);
    if (message.googleInAppPurchaseOrderList) {
      obj.googleInAppPurchaseOrderList = message.googleInAppPurchaseOrderList.map(
        (e) => (e ? GoogleInAppPurchaseOrder.toJSON(e) : undefined)
      );
    } else {
      obj.googleInAppPurchaseOrderList = [];
    }
    message.googleIAPOrderCount !== undefined &&
      (obj.googleIAPOrderCount = message.googleIAPOrderCount);
    if (message.executionList) {
      obj.executionList = message.executionList.map((e) =>
        e ? Execution.toJSON(e) : undefined
      );
    } else {
      obj.executionList = [];
    }
    message.executionCount !== undefined &&
      (obj.executionCount = message.executionCount);
    if (message.pendingExecutionList) {
      obj.pendingExecutionList = message.pendingExecutionList.map((e) =>
        e ? Execution.toJSON(e) : undefined
      );
    } else {
      obj.pendingExecutionList = [];
    }
    message.pendingExecutionCount !== undefined &&
      (obj.pendingExecutionCount = message.pendingExecutionCount);
    if (message.itemList) {
    ...
    if (message.recipeList) {
      obj.recipeList = message.recipeList.map((e) =>
    ...
    if (message.cookbookList) {
      obj.cookbookList = message.cookbookList.map((e) =>
  ...
  fromPartial(object: DeepPartial<GenesisState>): GenesisState {
    ...
    if (object.redeemInfoList !== undefined && object.redeemInfoList !== null) {
      for (const e of object.redeemInfoList) {
        message.redeemInfoList.push(RedeemInfo.fromPartial(e));
      }
    }
    if (
      object.paymentInfoList !== undefined &&
      ...
      for (const e of object.paymentInfoList) {
        message.paymentInfoList.push(PaymentInfo.fromPartial(e));
      }
    }
    if (object.accountList !== undefined && object.accountList !== null) {
      for (const e of object.accountList) {
    ...
    if (
      ...
      for (const e of object.googleInAppPurchaseOrderList) {
        message.googleInAppPurchaseOrderList.push(
          GoogleInAppPurchaseOrder.fromPartial(e)
        );
      }
    }
    if (
