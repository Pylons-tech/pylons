...
export const MsgBurnDebtToken = {
  encode(message: MsgBurnDebtToken, writer: Writer = Writer.create()): Writer {
    if (message.creator !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgBurnDebtToken {
    ...
    const message = { ...baseMsgBurnDebtToken } as MsgBurnDebtToken;
...
const baseMsgBurnDebtTokenResponse: object = {};

export const MsgBurnDebtTokenResponse = {
  encode(
    _: MsgBurnDebtTokenResponse,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgBurnDebtTokenResponse,
    } as MsgBurnDebtTokenResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgBurnDebtTokenResponse>
  ): MsgBurnDebtTokenResponse {
    const message = {
      ...baseMsgBurnDebtTokenResponse,
    } as MsgBurnDebtTokenResponse;
...
export const MsgFulfillTrade = {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          message.paymentInfos.push(
            PaymentInfo.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromJSON(object: any): MsgFulfillTrade {
    ...
    if (
      object.coinInputsIndex !== undefined &&
      object.coinInputsIndex !== null
    ) {
    ...
    if (object.paymentInfos !== undefined && object.paymentInfos !== null) {
      for (const e of object.paymentInfos) {
        message.paymentInfos.push(PaymentInfo.fromJSON(e));
      }
    }
    return message;
  },
  ...
  toJSON(message: MsgFulfillTrade): unknown {
    ...
    message.coinInputsIndex !== undefined &&
      (obj.coinInputsIndex = message.coinInputsIndex);
    if (message.items) {
...
export const MsgFulfillTradeResponse = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgFulfillTradeResponse {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgFulfillTradeResponse,
    } as MsgFulfillTradeResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgFulfillTradeResponse>
...
export const MsgCreateTradeResponse = {
  ...
  fromPartial(
    object: DeepPartial<MsgCreateTradeResponse>
...
export const MsgCompleteExecutionEarly = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCompleteExecutionEarly,
    } as MsgCompleteExecutionEarly;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCompleteExecutionEarly>
  ): MsgCompleteExecutionEarly {
    const message = {
      ...baseMsgCompleteExecutionEarly,
    } as MsgCompleteExecutionEarly;
...
export const MsgCompleteExecutionEarlyResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCompleteExecutionEarlyResponse,
    } as MsgCompleteExecutionEarlyResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCompleteExecutionEarlyResponse>
  ): MsgCompleteExecutionEarlyResponse {
    const message = {
      ...baseMsgCompleteExecutionEarlyResponse,
    } as MsgCompleteExecutionEarlyResponse;
...
export const MsgTransferCookbookResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgTransferCookbookResponse,
    } as MsgTransferCookbookResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgTransferCookbookResponse>
  ): MsgTransferCookbookResponse {
    const message = {
      ...baseMsgTransferCookbookResponse,
    } as MsgTransferCookbookResponse;
...
const baseMsgGoogleInAppPurchaseGetCoins: object = {
  creator: "",
  productID: "",
  purchaseToken: "",
  receiptDataBase64: "",
...
export const MsgGoogleInAppPurchaseGetCoins = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgGoogleInAppPurchaseGetCoins,
    } as MsgGoogleInAppPurchaseGetCoins;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MsgGoogleInAppPurchaseGetCoins {
    ...
    if (
      object.receiptDataBase64 !== undefined &&
  ...
  fromPartial(
    object: DeepPartial<MsgGoogleInAppPurchaseGetCoins>
  ): MsgGoogleInAppPurchaseGetCoins {
    const message = {
      ...baseMsgGoogleInAppPurchaseGetCoins,
    } as MsgGoogleInAppPurchaseGetCoins;
...
export const MsgGoogleInAppPurchaseGetCoinsResponse = {
  encode(
    _: MsgGoogleInAppPurchaseGetCoinsResponse,
    writer: Writer = Writer.create()
  ): Writer {
    return writer;
  },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgGoogleInAppPurchaseGetCoinsResponse,
    } as MsgGoogleInAppPurchaseGetCoinsResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgGoogleInAppPurchaseGetCoinsResponse>
  ): MsgGoogleInAppPurchaseGetCoinsResponse {
    const message = {
      ...baseMsgGoogleInAppPurchaseGetCoinsResponse,
    } as MsgGoogleInAppPurchaseGetCoinsResponse;
...
const baseMsgExecuteRecipe: object = {
  creator: "",
  cookbookID: "",
  recipeID: "",
  coinInputsIndex: 0,
...
export const MsgExecuteRecipeResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgExecuteRecipeResponse,
    } as MsgExecuteRecipeResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgExecuteRecipeResponse>
  ): MsgExecuteRecipeResponse {
    const message = {
      ...baseMsgExecuteRecipeResponse,
    } as MsgExecuteRecipeResponse;
...
const baseMsgSetItemString: object = {
  creator: "",
  cookbookID: "",
  ID: "",
  field: "",
...
export const MsgSetItemStringResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgSetItemStringResponse,
    } as MsgSetItemStringResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgSetItemStringResponse>
  ): MsgSetItemStringResponse {
    const message = {
      ...baseMsgSetItemStringResponse,
    } as MsgSetItemStringResponse;
...
export const MsgCreateRecipeResponse = {
  ...
  fromPartial(
    _: DeepPartial<MsgCreateRecipeResponse>
...
export const MsgUpdateRecipeResponse = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgUpdateRecipeResponse {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgUpdateRecipeResponse,
    } as MsgUpdateRecipeResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateRecipeResponse>
...
export const MsgCreateCookbookResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateCookbookResponse,
    } as MsgCreateCookbookResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgCreateCookbookResponse>
  ): MsgCreateCookbookResponse {
    const message = {
      ...baseMsgCreateCookbookResponse,
    } as MsgCreateCookbookResponse;
...
export const MsgUpdateCookbookResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgUpdateCookbookResponse,
    } as MsgUpdateCookbookResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateCookbookResponse>
  ): MsgUpdateCookbookResponse {
    const message = {
      ...baseMsgUpdateCookbookResponse,
    } as MsgUpdateCookbookResponse;
...
export interface Msg {
  ...
  CompleteExecutionEarly(
    request: MsgCompleteExecutionEarly
  ): Promise<MsgCompleteExecutionEarlyResponse>;
  TransferCookbook(
    request: MsgTransferCookbook
  ): Promise<MsgTransferCookbookResponse>;
  GoogleInAppPurchaseGetCoins(
    request: MsgGoogleInAppPurchaseGetCoins
  ): Promise<MsgGoogleInAppPurchaseGetCoinsResponse>;
  ...
  CreateCookbook(
    request: MsgCreateCookbook
  ): Promise<MsgCreateCookbookResponse>;
  UpdateCookbook(
    request: MsgUpdateCookbook
  ): Promise<MsgUpdateCookbookResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  BurnDebtToken(request: MsgBurnDebtToken): Promise<MsgBurnDebtTokenResponse> {
    ...
    return promise.then((data) =>
      MsgBurnDebtTokenResponse.decode(new Reader(data))
    );
  }
  ...
  FulfillTrade(request: MsgFulfillTrade): Promise<MsgFulfillTradeResponse> {
    ...
    return promise.then((data) =>
      MsgFulfillTradeResponse.decode(new Reader(data))
    );
  }
  ...
  CreateTrade(request: MsgCreateTrade): Promise<MsgCreateTradeResponse> {
    ...
    return promise.then((data) =>
      MsgCreateTradeResponse.decode(new Reader(data))
    );
  }
  ...
  CancelTrade(request: MsgCancelTrade): Promise<MsgCancelTradeResponse> {
    ...
    return promise.then((data) =>
      MsgCancelTradeResponse.decode(new Reader(data))
    );
  }
  ...
  CompleteExecutionEarly(
    ...
    return promise.then((data) =>
      MsgCompleteExecutionEarlyResponse.decode(new Reader(data))
    );
  }
  ...
  TransferCookbook(
    ...
    return promise.then((data) =>
      MsgTransferCookbookResponse.decode(new Reader(data))
    );
  }
  ...
  GoogleInAppPurchaseGetCoins(
    ...
    return promise.then((data) =>
      MsgGoogleInAppPurchaseGetCoinsResponse.decode(new Reader(data))
    );
  }
  ...
  SendItems(request: MsgSendItems): Promise<MsgSendItemsResponse> {
    ...
    return promise.then((data) =>
      MsgSendItemsResponse.decode(new Reader(data))
    );
  }
  ...
  ExecuteRecipe(request: MsgExecuteRecipe): Promise<MsgExecuteRecipeResponse> {
    ...
    return promise.then((data) =>
      MsgExecuteRecipeResponse.decode(new Reader(data))
    );
  }
  ...
  SetItemString(request: MsgSetItemString): Promise<MsgSetItemStringResponse> {
    ...
    return promise.then((data) =>
      MsgSetItemStringResponse.decode(new Reader(data))
    );
  }
  ...
  UpdateRecipe(request: MsgUpdateRecipe): Promise<MsgUpdateRecipeResponse> {
    ...
    return promise.then((data) =>
      MsgUpdateRecipeResponse.decode(new Reader(data))
    );
  }
  ...
  CreateCookbook(
    ...
    return promise.then((data) =>
      MsgCreateCookbookResponse.decode(new Reader(data))
    );
  }
  ...
  UpdateCookbook(
    ...
    return promise.then((data) =>
      MsgUpdateCookbookResponse.decode(new Reader(data))
    );
  }
}
