...
export type PylonsMsgBurnDebtTokenResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  queryPaymentInfo = (purchaseID: string, params: RequestParams = {}) =>
    this.request<PylonsQueryGetPaymentInfoResponse, RpcStatus>({
  ...
  queryPaymentInfoAll = (
    ...
    this.request<PylonsQueryAllPaymentInfoResponse, RpcStatus>({
   ...
   */
  queryRedeemInfo = (ID: string, params: RequestParams = {}) =>
    this.request<PylonsQueryGetRedeemInfoResponse, RpcStatus>({
  ...
  queryRedeemInfoAll = (
    ...
    this.request<PylonsQueryAllRedeemInfoResponse, RpcStatus>({
      path: `/pylons/redeems`,
      method: "GET",
      query: query,
      format: "json",
  ...
  queryListTradesByCreator = (
    ...
    this.request<PylonsQueryListTradesByCreatorResponse, RpcStatus>({
