...
export const Execution = {
  ...
  fromJSON(object: any): Execution {
    ...
    if (
      object.itemModifyOutputIDs !== undefined &&
      object.itemModifyOutputIDs !== null
    ) {
  ...
  toJSON(message: Execution): unknown {
    ...
    message.recipeVersion !== undefined &&
      (obj.recipeVersion = message.recipeVersion);
    ...
    if (message.itemInputs) {
      obj.itemInputs = message.itemInputs.map((e) =>
        e ? ItemRecord.toJSON(e) : undefined
      );
    } else {
      obj.itemInputs = [];
    }
