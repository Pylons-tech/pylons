...
const baseGoogleInAppPurchasePackage: object = {
  packageName: "",
  productID: "",
  amount: "",
};
...
export const GoogleInAppPurchasePackage = {
  ...
  fromPartial(
    object: DeepPartial<GoogleInAppPurchasePackage>
  ): GoogleInAppPurchasePackage {
    const message = {
      ...baseGoogleInAppPurchasePackage,
    } as GoogleInAppPurchasePackage;
...
export const CoinIssuer = {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.packages.push(
            GoogleInAppPurchasePackage.decode(reader, reader.uint32())
          );
          break;
        case 3:
  ...
  fromJSON(object: any): CoinIssuer {
    ...
    if (
      object.googleInAppPurchasePubKey !== undefined &&
      object.googleInAppPurchasePubKey !== null
    ) {
      message.googleInAppPurchasePubKey = String(
        object.googleInAppPurchasePubKey
      );
    } else {
  ...
  toJSON(message: CoinIssuer): unknown {
    ...
    if (message.packages) {
      obj.packages = message.packages.map((e) =>
        e ? GoogleInAppPurchasePackage.toJSON(e) : undefined
      );
    } else {
      obj.packages = [];
    }
...
const basePaymentProcessor: object = {
  CoinDenom: "",
  pubKey: "",
  processorPercentage: "",
...
export const PaymentProcessor = {
  encode(message: PaymentProcessor, writer: Writer = Writer.create()): Writer {
    if (message.CoinDenom !== "") {
      writer.uint32(10).string(message.CoinDenom);
    }
    if (message.pubKey !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): PaymentProcessor {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...basePaymentProcessor } as PaymentProcessor;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): PaymentProcessor {
    ...
    if (
      object.processorPercentage !== undefined &&
    ...
    if (
      object.validatorsPercentage !== undefined &&
...
export const Params = {
  ...
  fromJSON(object: any): Params {
    ...
    if (
      object.paymentProcessors !== undefined &&
    ...
    if (
      object.recipeFeePercentage !== undefined &&
    ...
    if (
      object.itemTransferFeePercentage !== undefined &&
      object.itemTransferFeePercentage !== null
    ) {
      message.itemTransferFeePercentage = String(
        object.itemTransferFeePercentage
      );
    } else {
      message.itemTransferFeePercentage = "";
    }
    if (
      object.updateItemStringFee !== undefined &&
    ...
    if (
      object.updateUsernameFee !== undefined &&
    ...
    if (
      object.distrEpochIdentifier !== undefined &&
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.paymentProcessors) {
      obj.paymentProcessors = message.paymentProcessors.map((e) =>
        e ? PaymentProcessor.toJSON(e) : undefined
      );
    } else {
  ...
  fromPartial(object: DeepPartial<Params>): Params {
    ...
    if (
      ...
      message.updateItemStringFee = Coin.fromPartial(
        object.updateItemStringFee
      );
    } else {
      message.updateItemStringFee = undefined;
    }
