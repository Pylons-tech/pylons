...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgEnlistForArena: (data: MsgEnlistForArena): EncodeObject => ({ typeUrl: "/Pylonstech.pylons.pylons.MsgEnlistForArena", value: data }),
    msgBurnDebtToken: (data: MsgBurnDebtToken): EncodeObject => ({ typeUrl: "/Pylonstech.pylons.pylons.MsgBurnDebtToken", value: data }),
