...
import { MsgSetCookbookDenomMetadata } from "./types/pylons/tx";
...
const types = [
  ...
  ["/Pylonstech.pylons.pylons.MsgSetCookbookDenomMetadata", MsgSetCookbookDenomMetadata],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgSetCookbookDenomMetadata: (data: MsgSetCookbookDenomMetadata): EncodeObject => ({ typeUrl: "/Pylonstech.pylons.pylons.MsgSetCookbookDenomMetadata", value: data }),
