...
const baseMsgSetCookbookDenomMetadata = { creator: '', cookbookID: '', denom: '', description: '', base: '', display: '' };
export const MsgSetCookbookDenomMetadata = {
    ...
    decode(input, length) {
        ...
        const message = { ...baseMsgSetCookbookDenomMetadata };
        message.denomUnits = [];
...
const baseMsgSetCookbookDenomMetadataResponse = {};
export const MsgSetCookbookDenomMetadataResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgSetCookbookDenomMetadataResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
const baseMsgExecuteRecipe = { creator: '', cookbookID: '', recipeID: '', coinInputsIndex: 0, itemIDs: '' };
...
export class MsgClientImpl {
    ...
    SetCookbookDenomMetadata(request) {
