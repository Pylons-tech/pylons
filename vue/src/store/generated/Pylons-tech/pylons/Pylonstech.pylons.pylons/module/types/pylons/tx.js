...
export const MsgEnlistForArena = {
    ...
    decode(input, length) {
        ...
        const message = { ...baseMsgEnlistForArena };
...
const baseMsgEnlistForArenaResponse = { ID: 0 };
...
const baseMsgBurnDebtToken = { creator: "" };
export const MsgBurnDebtToken = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgBurnDebtToken };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseMsgBurnDebtTokenResponse = {};
...
const baseMsgFulfillTrade = { creator: "", ID: 0, coinInputsIndex: 0 };
export const MsgFulfillTrade = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.coinInputsIndex = longToNumber(reader.uint64());
                    break;
                case 4:
    ...
    fromJSON(object) {
        ...
        if (object.coinInputsIndex !== undefined &&
...
const baseMsgFulfillTradeResponse = {};
...
const baseMsgCreateTrade = { creator: "", extraInfo: "" };
...
export const MsgCancelTrade = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgCancelTrade };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseMsgCancelTradeResponse = {};
export const MsgCancelTradeResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof Uint8Array ? new Reader(input) : input;
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseMsgCancelTradeResponse };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
const baseMsgGoogleInAppPurchaseGetCoins = {
    creator: "",
    productID: "",
    purchaseToken: "",
    receiptDataBase64: "",
...
export class MsgClientImpl {
    ...
    EnlistForArena(request) {
        const data = MsgEnlistForArena.encode(request).finish();
        const promise = this.rpc.request("Pylonstech.pylons.pylons.Msg", "EnlistForArena", data);
        return promise.then((data) => MsgEnlistForArenaResponse.decode(new Reader(data)));
    }
    BurnDebtToken(request) {
        const data = MsgBurnDebtToken.encode(request).finish();
        const promise = this.rpc.request("Pylonstech.pylons.pylons.Msg", "BurnDebtToken", data);
        return promise.then((data) => MsgBurnDebtTokenResponse.decode(new Reader(data)));
    }
