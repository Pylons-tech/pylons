...
const baseQueryListTradesByCreatorRequest = { creator: "" };
...
const baseQueryListTradesByCreatorResponse = {};
...
const baseQueryGetRedeemInfoRequest = { ID: "" };
...
const baseQueryGetRedeemInfoResponse = {};
...
const baseQueryAllRedeemInfoRequest = {};
...
const baseQueryAllRedeemInfoResponse = {};
...
const baseQueryGetPaymentInfoRequest = { purchaseID: "" };
...
const baseQueryGetPaymentInfoResponse = {};
...
const baseQueryAllPaymentInfoRequest = {};
...
const baseQueryAllPaymentInfoResponse = {};
...
const baseQueryGetGoogleInAppPurchaseOrderRequest = {
    PurchaseToken: "",
};
...
const baseQueryListExecutionsByItemRequest = {
    CookbookID: "",
    ItemID: "",
};
...
export const QueryListExecutionsByItemResponse = {
    ...
    fromJSON(object) {
        ...
        message.CompletedExecutions = [];
        message.PendingExecutions = [];
        if (object.CompletedExecutions !== undefined &&
        ...
        if (object.PendingExecutions !== undefined &&
...
const baseQueryListExecutionsByRecipeRequest = {
    CookbookID: "",
    RecipeID: "",
};
...
export class QueryClientImpl {
    ...
    RedeemInfo(request) {
        ...
        const promise = this.rpc.request("Pylonstech.pylons.pylons.Query", "RedeemInfo", data);
        return promise.then((data) => QueryGetRedeemInfoResponse.decode(new Reader(data)));
    }
    RedeemInfoAll(request) {
        const data = QueryAllRedeemInfoRequest.encode(request).finish();
        const promise = this.rpc.request("Pylonstech.pylons.pylons.Query", "RedeemInfoAll", data);
        return promise.then((data) => QueryAllRedeemInfoResponse.decode(new Reader(data)));
    }
    PaymentInfo(request) {
        const data = QueryGetPaymentInfoRequest.encode(request).finish();
        const promise = this.rpc.request("Pylonstech.pylons.pylons.Query", "PaymentInfo", data);
        return promise.then((data) => QueryGetPaymentInfoResponse.decode(new Reader(data)));
    }
    PaymentInfoAll(request) {
        const data = QueryAllPaymentInfoRequest.encode(request).finish();
        const promise = this.rpc.request("Pylonstech.pylons.pylons.Query", "PaymentInfoAll", data);
        return promise.then((data) => QueryAllPaymentInfoResponse.decode(new Reader(data)));
    }
