...
const baseEventBurnDebtToken: object = {};
...
export const EventBurnDebtToken = {
  ...
  decode(input: Reader | Uint8Array, length?: number): EventBurnDebtToken {
    ...
    const message = { ...baseEventBurnDebtToken } as EventBurnDebtToken;
...
export const EventUpdateCookbook = {
  ...
  fromJSON(object: any): EventUpdateCookbook {
    const message = { ...baseEventUpdateCookbook } as EventUpdateCookbook;
    if (
      object.originalCookbook !== undefined &&
      object.originalCookbook !== null
    ) {
  ...
  toJSON(message: EventUpdateCookbook): unknown {
    const obj: any = {};
    message.originalCookbook !== undefined &&
      (obj.originalCookbook = message.originalCookbook
        ? Cookbook.toJSON(message.originalCookbook)
        : undefined);
    return obj;
  },
...
export const EventTransferCookbook = {
  ...
  fromPartial(
    object: DeepPartial<EventTransferCookbook>
...
export const EventUpdateRecipe = {
  ...
  toJSON(message: EventUpdateRecipe): unknown {
    const obj: any = {};
    message.originalRecipe !== undefined &&
      (obj.originalRecipe = message.originalRecipe
        ? Recipe.toJSON(message.originalRecipe)
        : undefined);
    return obj;
  },
...
export const EventCompleteExecution = {
  ...
  toJSON(message: EventCompleteExecution): unknown {
    ...
    if (message.burnCoins) {
      obj.burnCoins = message.burnCoins.map((e) =>
    ...
    if (message.payCoins) {
      obj.payCoins = message.payCoins.map((e) =>
        e ? Coin.toJSON(e) : undefined
      );
    } else {
      obj.payCoins = [];
    ...
    if (message.transferCoins) {
      obj.transferCoins = message.transferCoins.map((e) =>
        e ? Coin.toJSON(e) : undefined
      );
    } else {
      obj.transferCoins = [];
    ...
    if (message.feeCoins) {
      obj.feeCoins = message.feeCoins.map((e) =>
        e ? Coin.toJSON(e) : undefined
      );
    } else {
      obj.feeCoins = [];
    ...
    if (message.mintItems) {
      obj.mintItems = message.mintItems.map((e) =>
    ...
    if (message.modifyItems) {
      obj.modifyItems = message.modifyItems.map((e) =>
        e ? Item.toJSON(e) : undefined
      );
    } else {
      obj.modifyItems = [];
  ...
  fromPartial(
    object: DeepPartial<EventCompleteExecution>
...
export const EventCompleteExecutionEarly = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseEventCompleteExecutionEarly,
    } as EventCompleteExecutionEarly;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<EventCompleteExecutionEarly>
  ): EventCompleteExecutionEarly {
    const message = {
      ...baseEventCompleteExecutionEarly,
    } as EventCompleteExecutionEarly;
...
export const EventSetItemString = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.originalMutableStrings.push(
  ...
  fromJSON(object: any): EventSetItemString {
    ...
    if (
      object.originalMutableStrings !== undefined &&
      object.originalMutableStrings !== null
    ) {
  ...
  toJSON(message: EventSetItemString): unknown {
    ...
    if (message.originalMutableStrings) {
      obj.originalMutableStrings = message.originalMutableStrings.map((e) =>
...
const baseEventGooglePurchase: object = {
  creator: "",
  productID: "",
  purchaseToken: "",
  receiptDataBase64: "",
