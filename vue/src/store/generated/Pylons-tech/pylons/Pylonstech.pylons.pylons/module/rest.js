...
export class HttpClient {
	...
	toQueryString(rawQuery) {
		...
		return keys
			.map((key) => (typeof query[key] === 'object' && !Array.isArray(query[key]) ? this.toQueryString(query[key]) : this.addQueryParam(query, key)))
			.join('&')
	}
...
export class Api extends HttpClient {
	constructor() {
		 ...
		 */
		this.queryUsernameByAddress = (address, params = {}) =>
			this.request({
		 ...
		 */
		this.queryAddressByUsername = (username, params = {}) =>
			this.request({
		 ...
		 */
		this.queryListCookbooksByCreator = (creator, query, params = {}) =>
			this.request({
		 ...
		 */
		this.queryListExecutionsByItem = (CookbookID, ItemID, query, params = {}) =>
			this.request({
		 ...
		 */
		this.queryListExecutionsByRecipe = (CookbookID, RecipeID, query, params = {}) =>
			this.request({
		 ...
		 */
		this.queryGoogleInAppPurchaseOrder = (PurchaseToken, params = {}) =>
			this.request({
		 ...
		 */
		this.queryItem = (CookbookID, ID, params = {}) =>
			this.request({
		 ...
		 */
		this.queryListItemByOwner = (owner, query, params = {}) =>
			this.request({
		 ...
		 */
		this.queryRecipe = (CookbookID, ID, params = {}) =>
			this.request({
		 ...
		 */
		this.queryListRecipesByCookbook = (CookbookID, query, params = {}) =>
			this.request({
