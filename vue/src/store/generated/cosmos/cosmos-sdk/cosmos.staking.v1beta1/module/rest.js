...
export class Api extends HttpClient {
	constructor() {
       ...
       */
		this.queryDelegatorUnbondingDelegations = (delegatorAddr, query, params = {}) =>
			this.request({
       ...
       */
		this.queryDelegatorValidator = (delegatorAddr, validatorAddr, params = {}) =>
			this.request({
       ...
       */
		this.queryUnbondingDelegation = (validatorAddr, delegatorAddr, params = {}) =>
			this.request({
		 ...
		 */
		this.queryValidatorUnbondingDelegations = (validatorAddr, query, params = {}) =>
			this.request({
