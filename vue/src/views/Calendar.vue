			...
			<v-col>
				...
				<v-sheet height="600">
					<v-calendar
						...
						@change="updateRange"
					/>
					<v-menu v-model="selectedOpen" :close-on-content-click="false" :activator="selectedElement" offset-x> </v-menu>
				</v-sheet>
			</v-col>
		</v-row>
		<v-dialog v-model="showEventDialog" width="500">
			<EventForm ref="form" :event="selectedEvent" @close="handleCloseDialog" @saved="showEventDialog = false" />
		</v-dialog>
	</v-container>
</template>
