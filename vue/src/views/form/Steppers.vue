							...
							<v-stepper ref="stepper" v-model="step" class="rounded-0 elevation-0">
								<v-stepper-header class="elevation-1">
									<template v-for="item in steps">
										<v-stepper-step :key="'book' + item.step" :step="item.step" :complete="item.complete" color="success" :rules="item.rules"
											>{{ item.text }}
										</v-stepper-step>
								...
								<v-stepper-items>
									<v-stepper-content :step="1">
										<FormAccount ref="formAccount" class="pa-1" />
									</v-stepper-content>
									<v-stepper-content :step="2">
										<FormRoom ref="formRoom" class="pa-1" />
									</v-stepper-content>
