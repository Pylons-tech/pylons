...
pylonsd init masternode --chain-id=pylons-testnet --home=$HOME/.pylonsd
...
pylonsd gentx node0 500000000stake --keyring-backend=test --chain-id=pylons-testnet --home=$HOME/.pylonsd
