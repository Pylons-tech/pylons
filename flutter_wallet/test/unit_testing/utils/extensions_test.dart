...
void main() {
  test('should create dynamic link for purchase', () {
    ...
    const String cookbookId = "Easel_CookBook_auto_cookbook_2022_04_12_204648_096";
    ...
    final dynamicLink = recipeId.createDynamicLink(cookbookId: cookbookId, address: address);
  ...
  test('should create purchase NFt Link ', () {
    ...
    final dynamicLink = tradeId.createPurchaseNFT(cookBookId: cookbookId, address: address);
