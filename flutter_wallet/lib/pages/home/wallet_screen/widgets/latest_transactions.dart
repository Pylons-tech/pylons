...
class LatestTransactions extends StatelessWidget {
  ...
  Column getAmountColumn({required TransactionHistory txHistory}) {
    if (txHistory.transactionTypeEnum == TransactionType.NFTSELL || txHistory.transactionTypeEnum == TransactionType.RECEIVE) {
      return Column(
  ...
  Future<void> onTxTapped({required TransactionHistory txHistory}) async {
    ...
    if (txHistory.transactionTypeEnum == TransactionType.NFTSELL || txHistory.transactionTypeEnum == TransactionType.NFTBUY) {
