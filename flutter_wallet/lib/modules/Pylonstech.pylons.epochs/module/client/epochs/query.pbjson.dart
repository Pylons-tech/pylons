...
const QueryEpochsInfoRequest$json = const {
  '1': 'QueryEpochsInfoRequest',
};

/// Descriptor for `QueryEpochsInfoRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryEpochsInfoRequestDescriptor = $convert.base64Decode('ChZRdWVyeUVwb2Noc0luZm9SZXF1ZXN0');
@$core.Deprecated('Use queryEpochsInfoResponseDescriptor instead')
const QueryEpochsInfoResponse$json = const {
...
final $typed_data.Uint8List queryEpochsInfoResponseDescriptor = $convert.base64Decode('ChdRdWVyeUVwb2Noc0luZm9SZXNwb25zZRJBCgZlcG9jaHMYASADKAsyIy5QeWxvbnN0ZWNoLnB5bG9ucy5lcG9jaHMuRXBvY2hJbmZvQgTI3h8AUgZlcG9jaHM=');
@$core.Deprecated('Use queryCurrentEpochRequestDescriptor instead')
const QueryCurrentEpochRequest$json = const {
...
final $typed_data.Uint8List queryCurrentEpochRequestDescriptor = $convert.base64Decode('ChhRdWVyeUN1cnJlbnRFcG9jaFJlcXVlc3QSHgoKaWRlbnRpZmllchgBIAEoCVIKaWRlbnRpZmllcg==');
@$core.Deprecated('Use queryCurrentEpochResponseDescriptor instead')
const QueryCurrentEpochResponse$json = const {
...
final $typed_data.Uint8List queryCurrentEpochResponseDescriptor = $convert.base64Decode('ChlRdWVyeUN1cnJlbnRFcG9jaFJlc3BvbnNlEiMKDWN1cnJlbnRfZXBvY2gYASABKANSDGN1cnJlbnRFcG9jaA==');
