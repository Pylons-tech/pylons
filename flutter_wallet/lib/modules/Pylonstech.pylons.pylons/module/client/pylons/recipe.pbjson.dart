...
final $typed_data.Uint8List longInputParamDescriptor =
    $convert.base64Decode('Cg5Mb25nSW5wdXRQYXJhbRIQCgNrZXkYASABKAlSA2tleRIbCgltaW5fdmFsdWUYAiABKANSCG1pblZhbHVlEhsKCW1heF92YWx1ZRgDIAEoA1IIbWF4VmFsdWU=');
...
const DoubleWeightRange$json = const {
  ...
  '2': const [
    ...
    const {'1': 'weight', '3': 3, '4': 1, '5': 4, '8': const {}, '10': 'weight'},
  ],
};
...
const IntWeightRange$json = const {
  '1': 'IntWeightRange',
  '2': const [
    const {'1': 'lower', '3': 1, '4': 1, '5': 3, '8': const {}, '10': 'lower'},
    const {'1': 'upper', '3': 2, '4': 1, '5': 3, '8': const {}, '10': 'upper'},
    const {'1': 'weight', '3': 3, '4': 1, '5': 4, '8': const {}, '10': 'weight'},
  ],
};
...
final $typed_data.Uint8List longParamDescriptor = $convert
    .base64Decode('CglMb25nUGFyYW0SEAoDa2V5GAEgASgJUgNrZXkSRwoMd2VpZ2h0UmFuZ2VzGAIgAygLMh0ucHlsb25zLnB5bG9ucy5JbnRXZWlnaHRSYW5nZUIEyN4fAFIMd2VpZ2h0UmFuZ2VzEhgKB3Byb2dyYW0YAyABKAlSB3Byb2dyYW0=');
...
final $typed_data.Uint8List coinOutputDescriptor =
    $convert.base64Decode('CgpDb2luT3V0cHV0Eg4KAmlkGAEgASgJUgJpZBIzCgRjb2luGAIgASgLMhkuY29zbW9zLmJhc2UudjFiZXRhMS5Db2luQgTI3h8AUgRjb2luEhgKB3Byb2dyYW0YAyABKAlSB3Byb2dyYW0=');
...
const WeightedOutputs$json = const {
  ...
  '2': const [
    ...
    const {'1': 'weight', '3': 2, '4': 1, '5': 4, '8': const {}, '10': 'weight'},
  ],
};

/// Descriptor for `WeightedOutputs`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List weightedOutputsDescriptor =
    $convert.base64Decode('Cg9XZWlnaHRlZE91dHB1dHMSIQoJZW50cnlfaWRzGAEgAygJQgTI3h8AUghlbnRyeUlkcxIzCgZ3ZWlnaHQYAiABKARCG+reHxd3ZWlnaHQsb21pdGVtcHR5LHN0cmluZ1IGd2VpZ2h0');
...
final $typed_data.Uint8List coinInputDescriptor =
    $convert.base64Decode('CglDb2luSW5wdXQSYQoFY29pbnMYASADKAsyGS5jb3Ntb3MuYmFzZS52MWJldGExLkNvaW5CMMjeHwCq3x8oZ2l0aHViLmNvbS9jb3Ntb3MvY29zbW9zLXNkay90eXBlcy5Db2luc1IFY29pbnM=');
