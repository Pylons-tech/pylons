...
class QueryListSignUpByReferee extends $pb.GeneratedMessage {
  ...
  factory QueryListSignUpByReferee.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory QueryListSignUpByReferee.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  QueryListSignUpByReferee clone() =>
      QueryListSignUpByReferee()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  QueryListSignUpByReferee copyWith(
          void Function(QueryListSignUpByReferee) updates) =>
      super.copyWith((message) => updates(message as QueryListSignUpByReferee))
          as QueryListSignUpByReferee; // ignore: deprecated_member_use
  ...
  static $pb.PbList<QueryListSignUpByReferee> createRepeated() =>
      $pb.PbList<QueryListSignUpByReferee>();
  @$core.pragma('dart2js:noInline')
  static QueryListSignUpByReferee getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QueryListSignUpByReferee>(create);
...
class QueryListSignUpByRefereeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$12.ReferralKV>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'signup',
        subBuilder: $12.ReferralKV.create)
    ..hasRequiredFields = false;
  ...
  factory QueryListSignUpByRefereeResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory QueryListSignUpByRefereeResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  QueryListSignUpByRefereeResponse clone() =>
      QueryListSignUpByRefereeResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  QueryListSignUpByRefereeResponse copyWith(
          void Function(QueryListSignUpByRefereeResponse) updates) =>
      super.copyWith(
              (message) => updates(message as QueryListSignUpByRefereeResponse))
          as QueryListSignUpByRefereeResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryListSignUpByRefereeResponse create() =>
      QueryListSignUpByRefereeResponse._();
  QueryListSignUpByRefereeResponse createEmptyInstance() => create();
  static $pb.PbList<QueryListSignUpByRefereeResponse> createRepeated() =>
      $pb.PbList<QueryListSignUpByRefereeResponse>();
  @$core.pragma('dart2js:noInline')
  static QueryListSignUpByRefereeResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<QueryListSignUpByRefereeResponse>(
          create);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$14.StripeRefund>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'refunds',
        $pb.PbFieldType.PM,
        subBuilder: $14.StripeRefund.create)
    ..hasRequiredFields = false;
