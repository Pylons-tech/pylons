...
import 'package:pylons_wallet/modules/Pylonstech.pylons.pylons/module/client/pylons/payment_info.pb.dart'
    as $7;
...
class StripeRefund extends $pb.GeneratedMessage {
  ...
  factory StripeRefund.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory StripeRefund.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  StripeRefund copyWith(void Function(StripeRefund) updates) =>
      super.copyWith((message) => updates(message as StripeRefund))
          as StripeRefund; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static StripeRefund create() => StripeRefund._();
  StripeRefund createEmptyInstance() => create();
  static $pb.PbList<StripeRefund> createRepeated() =>
      $pb.PbList<StripeRefund>();
  @$core.pragma('dart2js:noInline')
  static StripeRefund getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<StripeRefund>(create);
