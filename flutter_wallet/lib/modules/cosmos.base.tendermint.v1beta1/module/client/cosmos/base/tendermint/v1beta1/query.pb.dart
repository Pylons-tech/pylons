...
import '../../../../tendermint/p2p/types.pb.dart' as $12;
...
class GetValidatorSetByHeightRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$9.PageRequest>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'pagination',
        subBuilder: $9.PageRequest.create)
  ...
  @$pb.TagNumber(2)
  set pagination($9.PageRequest v) {
    setField(2, v);
  }
...
class GetValidatorSetByHeightResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$9.PageResponse>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'pagination',
        subBuilder: $9.PageResponse.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  set pagination($9.PageResponse v) {
    setField(3, v);
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$7.BlockID>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'blockId',
        subBuilder: $7.BlockID.create)
    ..aOM<$11.Block>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'block',
        subBuilder: $11.Block.create)
    ..hasRequiredFields = false;
...
class GetNodeInfoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.base.tendermint.v1beta1'),
      createEmptyInstance: create)
    ..aOM<$12.DefaultNodeInfo>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'defaultNodeInfo',
        subBuilder: $12.DefaultNodeInfo.create)
    ..aOM<VersionInfo>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory GetNodeInfoResponse({
    $12.DefaultNodeInfo? defaultNodeInfo,
  ...
  @$pb.TagNumber(1)
  $12.DefaultNodeInfo get defaultNodeInfo => $_getN(0);
  @$pb.TagNumber(1)
  set defaultNodeInfo($12.DefaultNodeInfo v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $12.DefaultNodeInfo ensureDefaultNodeInfo() => $_ensure(0);
