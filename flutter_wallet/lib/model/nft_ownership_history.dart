...
class NftOwnershipHistory {
 ...
 factory NftOwnershipHistory.fromJson(Map<String, dynamic> json) {
    ...
    return NftOwnershipHistory(receiver: receiver, cookbookID: cookbookID, amount: amount, sender: sender, senderName: senderName, itemID: itemID, createdAt: createdAt, recipeID:
        recipeID);
