...
class LocalDataSourceImpl implements LocalDataSource {
  ...
  Future<bool> updateNftFromDescription(SaveNft saveNft) async {
    try {
      ...
      return throw LocaleKeys.uploadError.tr();
    }
  }
  ...
  Future<bool> updateNftFromPrice(SaveNft saveNft) async {
    try {
      ...
      throw CacheFailure(LocaleKeys.uploadError.tr());
    }
  }
  ...
  Future<bool> deleteNft(int id) async {
    try {
      ...
      throw CacheFailure(LocaleKeys.deleteError.tr());
    }
  }
  ...
  Future<NFT?> getNft(int id) async {
    try {
      ...
      throw CacheFailure(LocaleKeys.getError.tr());
    }
  }
}
