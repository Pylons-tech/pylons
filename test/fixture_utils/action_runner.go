...
func RegisterDefaultActionRunners() {
	...
	RegisterActionRunner("stripe_create_product", RunStripeCreateProduct)
	RegisterActionRunner("stripe_create_price", RunStripeCreatePrice)
	RegisterActionRunner("stripe_create_sku", RunStripeCreateSku)
