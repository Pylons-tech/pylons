...
final $typed_data.Uint8List queryListTradesByCreatorResponseDescriptor =
    $convert.base64Decode(
        'CiBRdWVyeUxpc3RUcmFkZXNCeUNyZWF0b3JSZXNwb25zZRIyCgZ0cmFkZXMYASADKAsyFC5weWxvbnMucHlsb25zLlRyYWRlQgTI3h8AUgZ0cmFkZXMSRwoKcGFnaW5hdGlvbhgCIAEoCzInLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlc3BvbnNlUgpwYWdpbmF0aW9uOgjooB8AiKAfAA==');
...
final $typed_data.Uint8List queryListItemByOwnerResponseDescriptor =
    $convert.base64Decode(
        'ChxRdWVyeUxpc3RJdGVtQnlPd25lclJlc3BvbnNlEi8KBWl0ZW1zGAEgAygLMhMucHlsb25zLnB5bG9ucy5JdGVtQgTI3h8AUgVpdGVtcxJHCgpwYWdpbmF0aW9uGAIgASgLMicuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVzcG9uc2VSCnBhZ2luYXRpb246COigHwCIoB8A');
@$core
...
final $typed_data.Uint8List queryListExecutionsByItemRequestDescriptor =
    $convert.base64Decode(
        'CiBRdWVyeUxpc3RFeGVjdXRpb25zQnlJdGVtUmVxdWVzdBIfCgtjb29rYm9va19pZBgBIAEoCVIKY29va2Jvb2tJZBIXCgdpdGVtX2lkGAIgASgJUgZpdGVtSWQSRgoKcGFnaW5hdGlvbhgDIAEoCzImLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlcXVlc3RSCnBhZ2luYXRpb246COigHwCIoB8A');
...
final $typed_data.Uint8List queryListExecutionsByRecipeRequestDescriptor =
    $convert.base64Decode(
        'CiJRdWVyeUxpc3RFeGVjdXRpb25zQnlSZWNpcGVSZXF1ZXN0Eh8KC2Nvb2tib29rX2lkGAEgASgJUgpjb29rYm9va0lkEhsKCXJlY2lwZV9pZBgCIAEoCVIIcmVjaXBlSWQSRgoKcGFnaW5hdGlvbhgDIAEoCzImLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlcXVlc3RSCnBhZ2luYXRpb246COigHwCIoB8A');
