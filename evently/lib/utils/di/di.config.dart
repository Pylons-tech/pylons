...
import 'package:evently/evently_provider.dart' as _i9;
...
import 'package:evently/utils/di/register_modules.dart' as _i10;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i8.Repository>(() => _i8.RepositoryImp(
          fileUtilsHelper: gh<_i7.FileUtilsHelper>(),
          localDataSource: gh<_i6.LocalDataSource>(),
        ));
    gh.lazySingleton<_i9.EventlyProvider>(
        () => _i9.EventlyProvider(repository: gh<_i8.Repository>()));
    return this;
  }
}
