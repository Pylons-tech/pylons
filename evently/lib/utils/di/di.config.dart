...
import 'package:evently/utils/file_utils_helper.dart' as _i4;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i4.FileUtilsHelper>(() => _i4.FileUtilsHelperImpl(
          imageCropper: gh<_i5.ImageCropper>(),
          filePicker: gh<_i6.FilePicker>(),
        ));
    gh.lazySingleton<_i7.Repository>(
        () => _i7.RepositoryImp(fileUtilsHelper: gh<_i4.FileUtilsHelper>()));
