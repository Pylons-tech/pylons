...
import 'package:evently/screens/event_hub/event_hub_view_model.dart' as _i15;
...
import 'package:evently/utils/di/register_modules.dart' as _i16;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i8.QuickNode>(
        () => _i8.QuickNodeImpl(httpClient: gh<_i6.Dio>()));
    ...
    gh.lazySingleton<_i15.EventHubViewModel>(
        () => _i15.EventHubViewModel(gh<_i13.Repository>()));
    return this;
  }
}
