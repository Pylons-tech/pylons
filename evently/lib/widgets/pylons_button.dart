...
class PylonsButton extends StatelessWidget {
  ...
  const PylonsButton({super.key, this.showArrow = false, this.textColor = Colors.white, required this.btnText, required this.onPressed, this.mobileScreenButtonWidth = 0.5, required this.color});
          ...
          child: Stack(
            children: [
              ...
              Center(
                child: Text(
                  btnText,
                  style: Theme.of(context).textTheme.bodyLarge!.copyWith(fontSize: 15.sp, color: textColor, fontWeight: FontWeight.w600),
                ),
              )
            ],
          ),
